...
def upgrade() -> None:
    ...
    op.create_index("ix_stock_inventory_management_tenant",
                    "stock_inventory_management", ["tenant_id"])
    ...
    op.create_index("ix_delivery_dispatch_tracking_tenant",
                    "delivery_dispatch_tracking", ["tenant_id"])
    ...
    op.create_index("ix_document_knowledge_qa_tenant",
                    "document_knowledge_qa", ["tenant_id"])
    ...
    op.create_index("ix_fleet_cost_and_pricing_tenant",
                    "fleet_cost_and_pricing", ["tenant_id"])
    ...
    op.create_index("ix_management_reporting_dashboard_tenant",
                    "management_reporting_dashboard", ["tenant_id"])
    ...
    op.create_index("ix_user_roles_workforce_tenant",
                    "user_roles_workforce", ["tenant_id"])
    ...
    op.create_index("ix_operational_procedures_readiness_tenant",
                    "operational_procedures_readiness", ["tenant_id"])
    ...
    op.create_index("ix_audit_evidence_trail_tenant",
                    "audit_evidence_trail", ["tenant_id"])


def downgrade() -> None:
    op.drop_index("ix_audit_evidence_trail_tenant", table_name="audit_evidence_trail")
    op.drop_table("audit_evidence_trail")
    op.drop_index("ix_operational_procedures_readiness_tenant", table_name="operational_procedures_readiness")
    op.drop_table("operational_procedures_readiness")
    op.drop_index("ix_user_roles_workforce_tenant", table_name="user_roles_workforce")
    op.drop_table("user_roles_workforce")
    op.drop_index("ix_management_reporting_dashboard_tenant", table_name="management_reporting_dashboard")
    op.drop_table("management_reporting_dashboard")
    op.drop_index("ix_fleet_cost_and_pricing_tenant", table_name="fleet_cost_and_pricing")
    op.drop_table("fleet_cost_and_pricing")
    op.drop_index("ix_document_knowledge_qa_tenant", table_name="document_knowledge_qa")
    op.drop_table("document_knowledge_qa")
    op.drop_index("ix_delivery_dispatch_tracking_tenant", table_name="delivery_dispatch_tracking")
    op.drop_table("delivery_dispatch_tracking")
    op.drop_index("ix_stock_inventory_management_tenant", table_name="stock_inventory_management")
