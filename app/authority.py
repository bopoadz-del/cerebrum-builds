"""Authority precedence (precedence.v1) for the Construction Platform.
...
an answer can always be audited back to the layer that produced it.
    ...
    1. certified   — signed valuation, variation order or approved record (highest)
    2. documents   — BOQs, drawings, method statements, price lists, subcontracts
    3. formulas    — arithmetic the platform computed (VAT, retention, valuations)
    4. procedures  — the contractor's standing procedure / defaults (lowest)
