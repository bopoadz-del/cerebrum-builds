...
BLOCK_CONTRACTS: Dict[str, Any] = {'analytics': {'block_id': 'analytics'}, 'audit': {'block_id': 'audit'}, 'capture': {'block_id': 'capture'}, 'dashboard': {'block_id': 'dashboard'}, 'database': {'block_id': 'database'}, 'document_engine': {'block_id': 'document_engine'}, 'event_bus': {'block_id': 'event_bus'}, 'evidence_verifier': {'block_id': 'evidence_verifier'}, 'file_hasher': {'block_id': 'file_hasher'}, 'formula_executor': {'block_id': 'formula_executor'}, 'knowledge': {'block_id': 'knowledge'}, 'memory': {'block_id': 'memory'}, 'notification': {'block_id': 'notification'}, 'portfolio_rollup': {'block_id': 'portfolio_rollup'}, 'queue': {'block_id': 'queue'}, 'readiness_engine': {'block_id': 'readiness_engine'}, 'storage': {'block_id': 'storage'}, 'team': {'block_id': 'team'}, 'validation': {'block_id': 'validation'}, 'workflow': {'block_id': 'workflow'}}
