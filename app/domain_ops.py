...
SPECS: Dict[str, Dict[str, Any]] = {'fleet_registry': {'entity': 'fleet_registry', 'fields': [{'name': 'plate_number', 'type': 'str', 'required': False}, {'name': 'vin', 'type': 'str', 'required': False}, {'name': 'branch', 'type': 'str', 'required': False}, {'name': 'category', 'type': 'str', 'required': False}, {'name': 'vehicle_state', 'type': 'str', 'required': False}, {'name': 'mileage', 'type': 'int', 'required': False, 'min': 0}, {'name': 'service_history', 'type': 'str', 'required': False}, {'name': 'attachment_path', 'type': 'str', 'required': False}, {'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}]}, 'rental_contract_management': {'entity': 'rental_contract_management', 'fields': [{'name': 'customer_name', 'type': 'str', 'required': False}, {'name': 'vehicle_reference', 'type': 'str', 'required': False}, {'name': 'branch', 'type': 'str', 'required': False}, {'name': 'pickup_date', 'type': 'str', 'required': False}, {'name': 'return_date', 'type': 'str', 'required': False}, {'name': 'extension_days', 'type': 'int', 'required': False, 'min': 0}, {'name': 'daily_rate', 'type': 'float', 'required': False, 'min': 0}, {'name': 'deposit_amount', 'type': 'float', 'required': False, 'min': 0}, {'name': 'damage_notes', 'type': 'str', 'required': False}, {'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}]}, 'maintenance_scheduling': {'entity': 'maintenance_scheduling', 'fields': [{'name': 'title', 'type': 'str', 'required': True}, {'name': 'vehicle_reference', 'type': 'str', 'required': False}, {'name': 'schedule_kind', 'type': 'str', 'required': False, 'allowed_values': ['date', 'mileage']}, {'name': 'due_date', 'type': 'str', 'required': False}, {'name': 'due_mileage', 'type': 'int', 'required': False, 'min': 0}, {'name': 'workshop', 'type': 'str', 'required': False}, {'name': 'downtime_days', 'type': 'int', 'required': False, 'min': 0}, {'name': 'estimated_cost', 'type': 'float', 'required': False, 'min': 0}, {'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}]}, 'pricing_and_rate_cards': {'entity': 'pricing_and_rate_cards', 'fields': [{'name': 'category', 'type': 'str', 'required': False}, {'name': 'branch', 'type': 'str', 'required': False}, {'name': 'season', 'type': 'str', 'required': False}, {'name': 'duration_days', 'type': 'int', 'required': False, 'min': 1}, {'name': 'base_rate', 'type': 'float', 'required': False, 'min': 0}, {'name': 'mileage_charge', 'type': 'float', 'required': False, 'min': 0}, {'name': 'fuel_charge', 'type': 'float', 'required': False, 'min': 0}, {'name': 'late_return_charge', 'type': 'float', 'required': False, 'min': 0}, {'name': 'extras_charge', 'type': 'float', 'required': False, 'min': 0}, {'name': 'deposit_amount', 'type': 'float', 'required': False, 'min': 0}, {'name': 'override_reason', 'type': 'str', 'required': False}, {'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}]}, 'invoicing_and_deposits': {'entity': 'invoicing_and_deposits', 'fields': [{'name': 'invoice_number', 'type': 'str', 'required': False}, {'name': 'contract_reference', 'type': 'str', 'required': False}, {'name': 'branch', 'type': 'str', 'required': False}, {'name': 'amount_due', 'type': 'float', 'required': False, 'min': 0}, {'name': 'deposit_held', 'type': 'float', 'required': False, 'min': 0}, {'name': 'credit_note', 'type': 'str', 'required': False}, {'name': 'balance_due', 'type': 'float', 'required': False, 'min': 0}, {'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}]}, 'multi_branch_rollup': {'entity': 'multi_branch_rollup', 'fields': [{'name': 'branch', 'type': 'str', 'required': False}, {'name': 'period', 'type': 'str', 'required': False}, {'name': 'fleet_utilisation', 'type': 'float', 'required': False, 'min': 0, 'max': 100}, {'name': 'revenue', 'type': 'float', 'required': False, 'min': 0}, {'name': 'cost', 'type': 'float', 'required': False, 'min': 0}, {'name': 'profit', 'type': 'float', 'required': False}, {'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}]}, 'reporting_analytics': {'entity': 'reporting_analytics', 'fields': [{'name': 'metric', 'type': 'str', 'required': False}, {'name': 'value', 'type': 'float', 'required': False, 'min': 0}, {'name': 'branch', 'type': 'str', 'required': False}, {'name': 'period', 'type': 'str', 'required': False}, {'name': 'query', 'type': 'str', 'required': False}, {'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}]}, 'audit_trail': {'entity': 'audit_trail', 'fields': [{'name': 'action_kind', 'type': 'str', 'required': False}, {'name': 'actor', 'type': 'str', 'required': False}, {'name': 'target', 'type': 'str', 'required': False}, {'name': 'detail', 'type': 'str', 'required': False}, {'name': 'content', 'type': 'str', 'required': False}, {'name': 'attachment_path', 'type': 'str', 'required': False}, {'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}]}}
DEFAULT_CAPABILITY = 'audit_trail'
DEFAULT_ENTITY = 'audit_trail'
SAMPLE = {'action_kind': 's10-row', 'actor': 's10-row', 'target': 's10-row', 'detail': 's10-row', 'content': 's10-row', 'attachment_path': 's10-row', 'reference': 's10-row', 'status': 'open'}
