...
SPECS: Dict[str, Dict[str, Any]] = {'record_checkin': {'entity': 'record_checkin', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'guest_name', 'type': 'str', 'required': True}, {'name': 'room_number', 'type': 'str', 'required': True}, {'name': 'nights', 'type': 'int', 'required': True, 'min': 1, 'max': 30}, {'name': 'arrival_time', 'type': 'time', 'required': True}, {'name': 'notes', 'type': 'str', 'required': False}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}]}, 'todays_arrivals_board': {'entity': 'todays_arrivals_board', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'arrival_date', 'type': 'date', 'required': True}, {'name': 'guest_name', 'type': 'str', 'required': True}, {'name': 'room_number', 'type': 'str', 'required': True}, {'name': 'arrived', 'type': 'bool', 'required': False}, {'name': 'arrivals_count', 'type': 'int', 'required': False, 'min': 0, 'max': 200}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}]}, 'room_availability_check': {'entity': 'room_availability_check', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'room_number', 'type': 'str', 'required': True}, {'name': 'check_in_date', 'type': 'date', 'required': True}, {'name': 'check_out_date', 'type': 'date', 'required': True}, {'name': 'is_available', 'type': 'bool', 'required': False}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}]}, 'guest_notes_and_preferences': {'entity': 'guest_notes_and_preferences', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'guest_name', 'type': 'str', 'required': True}, {'name': 'room_number', 'type': 'str', 'required': False}, {'name': 'preference', 'type': 'str', 'required': False}, {'name': 'note', 'type': 'str', 'required': False}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}]}, 'checkin_notifications': {'entity': 'checkin_notifications', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'guest_name', 'type': 'str', 'required': True}, {'name': 'room_number', 'type': 'str', 'required': True}, {'name': 'channel', 'type': 'str', 'required': False, 'allowed_values': ['mcp', 'email']}, {'name': 'recipient', 'type': 'str', 'required': False}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}]}, 'daily_checkin_summary': {'entity': 'daily_checkin_summary', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'summary_date', 'type': 'date', 'required': True}, {'name': 'arrivals_count', 'type': 'int', 'required': False, 'min': 0, 'max': 500}, {'name': 'occupancy_percent', 'type': 'float', 'required': False, 'min': 0, 'max': 100}, {'name': 'no_show_count', 'type': 'int', 'required': False, 'min': 0, 'max': 100}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}]}, 'audit_trail': {'entity': 'audit_trail', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'actor', 'type': 'str', 'required': True}, {'name': 'change_type', 'type': 'str', 'required': False, 'allowed_values': ['create', 'update', 'delete']}, {'name': 'subject_capability', 'type': 'str', 'required': False}, {'name': 'changed_at', 'type': 'datetime', 'required': False}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}]}}
DEFAULT_CAPABILITY = 'audit_trail'
DEFAULT_ENTITY = 'audit_trail'
SAMPLE = {'reference': 's10-row', 'actor': 's10-row', 'change_type': 'create', 'subject_capability': 's10-row', 'changed_at': 's10-row', 'status': 'open'}
