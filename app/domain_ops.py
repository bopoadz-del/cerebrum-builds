...
SPECS: Dict[str, Dict[str, Any]] = {'patient_records': {'entity': 'patient_records', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'pet_name', 'type': 'str', 'required': True}, {'name': 'species', 'type': 'str', 'required': False}, {'name': 'breed', 'type': 'str', 'required': False}, {'name': 'owner_name', 'type': 'str', 'required': True}, {'name': 'owner_email', 'type': 'email', 'required': False}, {'name': 'owner_phone', 'type': 'str', 'required': False}, {'name': 'date_of_birth', 'type': 'date', 'required': False}, {'name': 'weight_kg', 'type': 'float', 'required': False, 'min': 0.0, 'max': 500.0}, {'name': 'vaccination_status', 'type': 'str', 'required': False}, {'name': 'allergies', 'type': 'str', 'required': False}, {'name': 'clinical_notes', 'type': 'str', 'required': False}]}, 'appointment_scheduling': {'entity': 'appointment_scheduling', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'pet_name', 'type': 'str', 'required': True}, {'name': 'owner_name', 'type': 'str', 'required': False}, {'name': 'veterinarian', 'type': 'str', 'required': True}, {'name': 'appointment_date', 'type': 'date', 'required': False}, {'name': 'appointment_time', 'type': 'time', 'required': False}, {'name': 'duration_minutes', 'type': 'int', 'required': False, 'min': 5, 'max': 480}, {'name': 'visit_reason', 'type': 'str', 'required': False}, {'name': 'room', 'type': 'str', 'required': False}, {'name': 'appointment_status', 'type': 'str', 'required': False}]}, 'treatment_management': {'entity': 'treatment_management', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'pet_name', 'type': 'str', 'required': True}, {'name': 'veterinarian', 'type': 'str', 'required': True}, {'name': 'treatment_type', 'type': 'str', 'required': False}, {'name': 'diagnosis', 'type': 'str', 'required': False}, {'name': 'procedure_notes', 'type': 'str', 'required': False}, {'name': 'medication', 'type': 'str', 'required': False}, {'name': 'dosage', 'type': 'str', 'required': False}, {'name': 'treatment_date', 'type': 'date', 'required': False}, {'name': 'follow_up_date', 'type': 'date', 'required': False}, {'name': 'attachment_path', 'type': 'str', 'required': False}]}, 'billing_invoicing': {'entity': 'billing_invoicing', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'invoice_number', 'type': 'str', 'required': True}, {'name': 'client_name', 'type': 'str', 'required': True}, {'name': 'pet_name', 'type': 'str', 'required': False}, {'name': 'line_items', 'type': 'str', 'required': False}, {'name': 'subtotal', 'type': 'float', 'required': False, 'min': 0.0, 'max': 1000000.0}, {'name': 'tax_rate', 'type': 'float', 'required': False, 'min': 0.0, 'max': 1.0}, {'name': 'total_amount', 'type': 'float', 'required': False, 'min': 0.0, 'max': 1000000.0}, {'name': 'payment_status', 'type': 'str', 'required': False}, {'name': 'payment_method', 'type': 'str', 'required': False}, {'name': 'invoice_date', 'type': 'date', 'required': False}, {'name': 'attachment_path', 'type': 'str', 'required': False}]}, 'inventory_management': {'entity': 'inventory_management', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'item_name', 'type': 'str', 'required': True}, {'name': 'sku', 'type': 'str', 'required': True}, {'name': 'category', 'type': 'str', 'required': False}, {'name': 'quantity', 'type': 'int', 'required': False, 'min': 0, 'max': 1000000}, {'name': 'reorder_level', 'type': 'int', 'required': False, 'min': 0, 'max': 100000}, {'name': 'unit_cost', 'type': 'float', 'required': False, 'min': 0.0, 'max': 100000.0}, {'name': 'supplier', 'type': 'str', 'required': False}, {'name': 'expiry_date', 'type': 'date', 'required': False}]}, 'audit_trail': {'entity': 'audit_trail', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'event_type', 'type': 'str', 'required': True}, {'name': 'entity_name', 'type': 'str', 'required': False}, {'name': 'entity_id', 'type': 'str', 'required': False}, {'name': 'actor', 'type': 'str', 'required': True}, {'name': 'actor_role', 'type': 'str', 'required': False}, {'name': 'action_taken', 'type': 'str', 'required': False}, {'name': 'details', 'type': 'str', 'required': False}, {'name': 'occurred_at', 'type': 'datetime', 'required': False}]}, 'role_management': {'entity': 'role_management', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'role_name', 'type': 'str', 'required': True}, {'name': 'display_name', 'type': 'str', 'required': False}, {'name': 'permissions', 'type': 'str', 'required': False}, {'name': 'access_level', 'type': 'str', 'required': False}, {'name': 'department', 'type': 'str', 'required': False}, {'name': 'is_active', 'type': 'bool', 'required': False}]}, 'clinic_analytics': {'entity': 'clinic_analytics', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'metric_name', 'type': 'str', 'required': True}, {'name': 'metric_value', 'type': 'float', 'required': False, 'min': 0.0, 'max': 100000000.0}, {'name': 'period', 'type': 'str', 'required': False}, {'name': 'period_start', 'type': 'date', 'required': False}, {'name': 'period_end', 'type': 'date', 'required': False}, {'name': 'dimension', 'type': 'str', 'required': False}]}}
DEFAULT_CAPABILITY = 'appointment_scheduling'
DEFAULT_ENTITY = 'appointment_scheduling'
SAMPLE = {'reference': 's10-row', 'status': 'open', 'pet_name': 's10-row', 'owner_name': 's10-row', 'veterinarian': 's10-row', 'appointment_date': 's10-row', 'appointment_time': 's10-row', 'duration_minutes': 5, 'visit_reason': 's10-row', 'room': 's10-row', 'appointment_status': 'open'}
