...
SPECS: Dict[str, Dict[str, Any]] = {'patient_visit_records': {'entity': 'patient_visit_records', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'allowed_values': ['open', 'in_progress', 'closed'], 'required': True}, {'name': 'patient_name', 'type': 'str', 'required': True}, {'name': 'tooth', 'type': 'str', 'required': True}, {'name': 'procedure', 'type': 'str', 'required': True}, {'name': 'fee', 'type': 'float', 'min': 0.0, 'max': 100000.0, 'required': False}, {'name': 'visit_date', 'type': 'str', 'format': 'date', 'required': False}, {'name': 'provider', 'type': 'str', 'required': False}, {'name': 'clinical_notes', 'type': 'str', 'required': False}]}, 'appointment_scheduling': {'entity': 'appointment_scheduling', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'allowed_values': ['open', 'in_progress', 'closed'], 'required': True}, {'name': 'patient_name', 'type': 'str', 'required': True}, {'name': 'patient_email', 'type': 'str', 'format': 'email', 'required': False}, {'name': 'scheduled_at', 'type': 'str', 'format': 'datetime', 'required': False}, {'name': 'provider', 'type': 'str', 'required': False}, {'name': 'chair_room', 'type': 'str', 'required': False}, {'name': 'appointment_type', 'type': 'str', 'allowed_values': ['exam', 'hygiene', 'treatment', 'follow_up', 'emergency'], 'required': True}, {'name': 'duration_minutes', 'type': 'int', 'min': 5, 'max': 480, 'required': False}, {'name': 'reminder_channel', 'type': 'str', 'allowed_values': ['email', 'sms', 'phone'], 'required': False}, {'name': 'notes', 'type': 'str', 'required': False}]}, 'todays_appointment_list': {'entity': 'todays_appointment_list', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'allowed_values': ['open', 'in_progress', 'closed'], 'required': True}, {'name': 'list_date', 'type': 'str', 'format': 'date', 'required': True}, {'name': 'patient_name', 'type': 'str', 'required': True}, {'name': 'provider', 'type': 'str', 'required': False}, {'name': 'procedure', 'type': 'str', 'required': False}, {'name': 'appointment_time', 'type': 'str', 'format': 'time', 'required': False}, {'name': 'appointment_status', 'type': 'str', 'allowed_values': ['scheduled', 'checked_in', 'completed', 'cancelled'], 'required': False}, {'name': 'chair_room', 'type': 'str', 'required': False}]}, 'day_before_email_reminders': {'entity': 'day_before_email_reminders', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'allowed_values': ['open', 'in_progress', 'closed'], 'required': True}, {'name': 'patient_name', 'type': 'str', 'required': True}, {'name': 'patient_email', 'type': 'str', 'format': 'email', 'required': True}, {'name': 'reminder_date', 'type': 'str', 'format': 'date', 'required': True}, {'name': 'appointment_at', 'type': 'str', 'format': 'datetime', 'required': False}, {'name': 'reminder_channel', 'type': 'str', 'allowed_values': ['email', 'sms', 'phone'], 'required': False}, {'name': 'message_body', 'type': 'str', 'required': False}, {'name': 'delivery_state', 'type': 'str', 'allowed_values': ['queued', 'sent', 'skipped', 'cancelled'], 'required': False}]}, 'patient_directory': {'entity': 'patient_directory', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'allowed_values': ['open', 'in_progress', 'closed'], 'required': True}, {'name': 'patient_name', 'type': 'str', 'required': True}, {'name': 'patient_email', 'type': 'str', 'format': 'email', 'required': False}, {'name': 'patient_phone', 'type': 'str', 'required': False}, {'name': 'date_of_birth', 'type': 'str', 'format': 'date', 'required': False}, {'name': 'primary_provider', 'type': 'str', 'required': False}, {'name': 'notes', 'type': 'str', 'required': False}]}, 'clinical_history_search': {'entity': 'clinical_history_search', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'allowed_values': ['open', 'in_progress', 'closed'], 'required': True}, {'name': 'patient_name', 'type': 'str', 'required': True}, {'name': 'tooth', 'type': 'str', 'required': False}, {'name': 'procedure', 'type': 'str', 'required': False}, {'name': 'provider', 'type': 'str', 'required': False}, {'name': 'visit_date', 'type': 'str', 'format': 'date', 'required': False}, {'name': 'date_from', 'type': 'str', 'format': 'date', 'required': False}, {'name': 'date_to', 'type': 'str', 'format': 'date', 'required': False}, {'name': 'search_notes', 'type': 'str', 'required': False}]}, 'role_based_access': {'entity': 'role_based_access', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'allowed_values': ['open', 'in_progress', 'closed'], 'required': True}, {'name': 'staff_name', 'type': 'str', 'required': True}, {'name': 'staff_email', 'type': 'str', 'format': 'email', 'required': False}, {'name': 'staff_role', 'type': 'str', 'allowed_values': ['dentist', 'hygienist', 'receptionist', 'admin'], 'required': True}, {'name': 'permission_scope', 'type': 'str', 'required': False}, {'name': 'active_from', 'type': 'str', 'format': 'date', 'required': False}]}}
DEFAULT_CAPABILITY = 'clinical_history_search'
DEFAULT_ENTITY = 'clinical_history_search'
SAMPLE = {'reference': 's10-row', 'status': 's10-row', 'patient_name': 's10-row', 'tooth': 's10-row', 'procedure': 's10-row', 'provider': 's10-row', 'visit_date': '2026-09-03', 'date_from': '2026-09-03', 'date_to': '2026-09-03', 'search_notes': 's10-row'}
