...
SPECS: Dict[str, Dict[str, Any]] = {'matter_management': {'entity': 'matter_management', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'matter_number', 'type': 'str', 'required': True}, {'name': 'matter_title', 'type': 'str', 'required': True}, {'name': 'client_name', 'type': 'str', 'required': True}, {'name': 'client_email', 'type': 'str', 'required': False}, {'name': 'practice_area', 'type': 'str', 'required': False}, {'name': 'responsible_attorney', 'type': 'str', 'required': False}, {'name': 'matter_stage', 'type': 'str', 'required': False}, {'name': 'priority', 'type': 'str', 'required': False}, {'name': 'opened_date', 'type': 'date', 'required': False}, {'name': 'deadline_date', 'type': 'date', 'required': False}, {'name': 'billing_type', 'type': 'str', 'required': False}, {'name': 'document_path', 'type': 'str', 'required': False}]}, 'client_intake': {'entity': 'client_intake', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'client_name', 'type': 'str', 'required': True}, {'name': 'client_email', 'type': 'str', 'required': False}, {'name': 'client_phone', 'type': 'str', 'required': False}, {'name': 'matter_type', 'type': 'str', 'required': False}, {'name': 'referral_source', 'type': 'str', 'required': False}, {'name': 'conflict_check', 'type': 'str', 'required': False}, {'name': 'risk_score', 'type': 'float', 'required': False}, {'name': 'estimated_fee', 'type': 'float', 'required': False}, {'name': 'retainer_amount', 'type': 'float', 'required': False}, {'name': 'document_path', 'type': 'str', 'required': False}, {'name': 'intake_date', 'type': 'date', 'required': False}]}, 'document_management': {'entity': 'document_management', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'document_title', 'type': 'str', 'required': True}, {'name': 'document_type', 'type': 'str', 'required': False}, {'name': 'matter_number', 'type': 'str', 'required': False}, {'name': 'version', 'type': 'str', 'required': False}, {'name': 'file_path', 'type': 'str', 'required': False}, {'name': 'content_hash', 'type': 'str', 'required': False}, {'name': 'confidentiality', 'type': 'str', 'required': False}, {'name': 'document_owner', 'type': 'str', 'required': False}, {'name': 'tags', 'type': 'str', 'required': False}, {'name': 'uploaded_by', 'type': 'str', 'required': False}, {'name': 'uploaded_at', 'type': 'datetime', 'required': False}]}, 'time_and_billing': {'entity': 'time_and_billing', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'timekeeper', 'type': 'str', 'required': True}, {'name': 'matter_number', 'type': 'str', 'required': True}, {'name': 'client_name', 'type': 'str', 'required': False}, {'name': 'client_email', 'type': 'str', 'required': False}, {'name': 'activity_date', 'type': 'date', 'required': False}, {'name': 'hours', 'type': 'float', 'required': False, 'min': 0.0, 'max': 1000.0}, {'name': 'hourly_rate', 'type': 'float', 'required': False, 'min': 0.0, 'max': 5000.0}, {'name': 'billable_amount', 'type': 'float', 'required': False}, {'name': 'invoice_number', 'type': 'str', 'required': False}, {'name': 'payment_status', 'type': 'str', 'required': False}, {'name': 'narrative', 'type': 'str', 'required': False}]}, 'client_portal': {'entity': 'client_portal', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'client_name', 'type': 'str', 'required': True}, {'name': 'client_email', 'type': 'str', 'required': False}, {'name': 'matter_number', 'type': 'str', 'required': False}, {'name': 'portal_access_level', 'type': 'str', 'required': False}, {'name': 'unread_messages', 'type': 'int', 'required': False, 'min': 0, 'max': 10000}, {'name': 'shared_documents', 'type': 'int', 'required': False, 'min': 0, 'max': 10000}, {'name': 'message_subject', 'type': 'str', 'required': False}, {'name': 'message_body', 'type': 'str', 'required': False}, {'name': 'last_login_at', 'type': 'datetime', 'required': False}, {'name': 'document_path', 'type': 'str', 'required': False}]}, 'legal_analytics': {'entity': 'legal_analytics', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'metric_name', 'type': 'str', 'required': True}, {'name': 'metric_value', 'type': 'float', 'required': False}, {'name': 'benchmark_value', 'type': 'float', 'required': False}, {'name': 'practice_area', 'type': 'str', 'required': False}, {'name': 'dimension', 'type': 'str', 'required': False}, {'name': 'period_start', 'type': 'date', 'required': False}, {'name': 'period_end', 'type': 'date', 'required': False}, {'name': 'source_matter', 'type': 'str', 'required': False}]}, 'compliance_audit': {'entity': 'compliance_audit', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'control_id', 'type': 'str', 'required': True}, {'name': 'framework', 'type': 'str', 'required': False}, {'name': 'regulation', 'type': 'str', 'required': False}, {'name': 'event_type', 'type': 'str', 'required': False}, {'name': 'actor', 'type': 'str', 'required': False}, {'name': 'actor_role', 'type': 'str', 'required': False}, {'name': 'action_taken', 'type': 'str', 'required': False}, {'name': 'evidence_ref', 'type': 'str', 'required': False}, {'name': 'findings', 'type': 'str', 'required': False}, {'name': 'occurred_at', 'type': 'datetime', 'required': False}]}}
DEFAULT_CAPABILITY = 'client_intake'
DEFAULT_ENTITY = 'client_intake'
SAMPLE = {'reference': 's10-row', 'status': 'open', 'client_name': 's10-row', 'client_email': 's10-row', 'client_phone': 's10-row', 'matter_type': 's10-row', 'referral_source': 's10-row', 'conflict_check': 's10-row', 'risk_score': 1.5, 'estimated_fee': 1.5, 'retainer_amount': 1.5, 'document_path': 's10-row', 'intake_date': 's10-row'}
