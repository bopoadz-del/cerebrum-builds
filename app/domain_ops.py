...
SPECS: Dict[str, Dict[str, Any]] = {'budget_planning_tracking': {'entity': 'budget_planning_tracking', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'department', 'type': 'str', 'required': True}, {'name': 'budget_owner', 'type': 'str', 'required': True}, {'name': 'cost_centre', 'type': 'str', 'required': False}, {'name': 'period', 'type': 'str', 'required': False}, {'name': 'planned_amount', 'type': 'float', 'required': False, 'min': 0}, {'name': 'actual_amount', 'type': 'float', 'required': False, 'min': 0}, {'name': 'currency', 'type': 'str', 'required': False}, {'name': 'notes', 'type': 'str', 'required': False}]}, 'spend_capture_categorisation': {'entity': 'spend_capture_categorisation', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'department', 'type': 'str', 'required': True}, {'name': 'supplier', 'type': 'str', 'required': True}, {'name': 'category', 'type': 'str', 'required': True, 'allowed_values': ['software', 'travel', 'facilities', 'professional_services', 'marketing']}, {'name': 'amount', 'type': 'float', 'required': False, 'min': 0}, {'name': 'currency', 'type': 'str', 'required': False}, {'name': 'invoice_date', 'type': 'date', 'required': False}, {'name': 'invoice_number', 'type': 'str', 'required': False}, {'name': 'document_path', 'type': 'str', 'required': False}, {'name': 'notes', 'type': 'str', 'required': False}]}, 'approval_workflow': {'entity': 'approval_workflow', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'department', 'type': 'str', 'required': True}, {'name': 'request_type', 'type': 'str', 'required': True, 'allowed_values': ['invoice', 'expense', 'budget_change']}, {'name': 'approver', 'type': 'str', 'required': True}, {'name': 'approver_email', 'type': 'str', 'required': False}, {'name': 'amount', 'type': 'float', 'required': False, 'min': 0}, {'name': 'threshold', 'type': 'float', 'required': False, 'min': 0}, {'name': 'priority', 'type': 'str', 'required': False, 'allowed_values': ['low', 'normal', 'high', 'urgent']}, {'name': 'submitted_at', 'type': 'datetime', 'required': False}, {'name': 'notes', 'type': 'str', 'required': False}]}, 'variance_analytics': {'entity': 'variance_analytics', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'department', 'type': 'str', 'required': True}, {'name': 'category', 'type': 'str', 'required': False}, {'name': 'period', 'type': 'str', 'required': False}, {'name': 'budget_amount', 'type': 'float', 'required': False, 'min': 0}, {'name': 'actual_amount', 'type': 'float', 'required': False, 'min': 0}, {'name': 'formula', 'type': 'str', 'required': False}, {'name': 'notes', 'type': 'str', 'required': False}]}, 'dashboard_portfolio_rollup': {'entity': 'dashboard_portfolio_rollup', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'department', 'type': 'str', 'required': True}, {'name': 'role_view', 'type': 'str', 'required': True, 'allowed_values': ['cfo', 'controller', 'budget_owner']}, {'name': 'view_scope', 'type': 'str', 'required': False}, {'name': 'period', 'type': 'str', 'required': False}, {'name': 'spend_total', 'type': 'float', 'required': False, 'min': 0}, {'name': 'commitment_total', 'type': 'float', 'required': False, 'min': 0}, {'name': 'forecast_total', 'type': 'float', 'required': False, 'min': 0}, {'name': 'risk_level', 'type': 'str', 'required': False, 'allowed_values': ['low', 'medium', 'high']}, {'name': 'notes', 'type': 'str', 'required': False}]}, 'audit_evidence_validation': {'entity': 'audit_evidence_validation', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'department', 'type': 'str', 'required': True}, {'name': 'record_type', 'type': 'str', 'required': True, 'allowed_values': ['invoice', 'expense', 'approval', 'budget']}, {'name': 'record_reference', 'type': 'str', 'required': True}, {'name': 'evidence_hash', 'type': 'str', 'required': False}, {'name': 'verified', 'type': 'bool', 'required': False}, {'name': 'checked_at', 'type': 'datetime', 'required': False}, {'name': 'notes', 'type': 'str', 'required': False}]}, 'finance_document_knowledge': {'entity': 'finance_document_knowledge', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'department', 'type': 'str', 'required': True}, {'name': 'document_type', 'type': 'str', 'required': True, 'allowed_values': ['invoice', 'contract', 'policy', 'price_list']}, {'name': 'question', 'type': 'str', 'required': True}, {'name': 'answer', 'type': 'str', 'required': False}, {'name': 'citations', 'type': 'str', 'required': False}, {'name': 'confidence', 'type': 'float', 'required': False, 'min': 0, 'max': 1}, {'name': 'document_path', 'type': 'str', 'required': False}]}, 'integrations_placeholders': {'entity': 'integrations_placeholders', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'department', 'type': 'str', 'required': True}, {'name': 'integration', 'type': 'str', 'required': True, 'allowed_values': ['google_drive', 'sage', 'email_slack']}, {'name': 'direction', 'type': 'str', 'required': True, 'allowed_values': ['inbound', 'outbound']}, {'name': 'detail', 'type': 'str', 'required': False}, {'name': 'external_reference', 'type': 'str', 'required': False}, {'name': 'last_sync_at', 'type': 'datetime', 'required': False}, {'name': 'notes', 'type': 'str', 'required': False}]}}
DEFAULT_CAPABILITY = 'budget_planning_tracking'
DEFAULT_ENTITY = 'budget_planning_tracking'
SAMPLE = {'reference': 'sample', 'status': 'open', 'department': 'sample', 'budget_owner': 'sample', 'cost_centre': 'sample', 'period': 'sample', 'planned_amount': 0.0, 'actual_amount': 0.0, 'currency': 'sample', 'notes': 'sample'}
