...
SPECS: Dict[str, Dict[str, Any]] = {'job_and_site_tracking': {'entity': 'job_and_site_tracking', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'job_code', 'type': 'str', 'required': True}, {'name': 'job_name', 'type': 'str', 'required': True}, {'name': 'site_name', 'type': 'str', 'required': True}, {'name': 'client_name', 'type': 'str', 'required': False}, {'name': 'work_front', 'type': 'str', 'required': False}, {'name': 'contract_value_aed', 'type': 'float', 'required': False, 'min': 0, 'max': 1000000000}, {'name': 'progress_percent', 'type': 'float', 'required': False, 'min': 0, 'max': 100}, {'name': 'milestone', 'type': 'str', 'required': False}, {'name': 'milestone_due_date', 'type': 'str', 'required': False, 'format': 'date'}, {'name': 'snag_open_count', 'type': 'int', 'required': False, 'min': 0, 'max': 10000}, {'name': 'variation_reference', 'type': 'str', 'required': False}, {'name': 'variation_status', 'type': 'str', 'required': False, 'allowed_values': ['draft', 'submitted', 'approved', 'rejected']}, {'name': 'notes', 'type': 'str', 'required': False}]}, 'commercials_and_valuations': {'entity': 'commercials_and_valuations', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'valuation_number', 'type': 'str', 'required': True}, {'name': 'job_code', 'type': 'str', 'required': True}, {'name': 'boq_item', 'type': 'str', 'required': False}, {'name': 'measured_quantity', 'type': 'float', 'required': False, 'min': 0, 'max': 10000000}, {'name': 'unit_rate_aed', 'type': 'float', 'required': False, 'min': 0, 'max': 10000000}, {'name': 'gross_value_aed', 'type': 'float', 'required': False, 'min': 0, 'max': 1000000000}, {'name': 'retention_percent', 'type': 'float', 'required': False, 'min': 0, 'max': 100}, {'name': 'retention_aed', 'type': 'float', 'required': False, 'min': 0, 'max': 1000000000}, {'name': 'vat_rate_percent', 'type': 'float', 'required': False, 'min': 0, 'max': 100}, {'name': 'vat_amount_aed', 'type': 'float', 'required': False, 'min': 0, 'max': 1000000000}, {'name': 'certified_value_aed', 'type': 'float', 'required': False, 'min': 0, 'max': 1000000000}, {'name': 'payment_status', 'type': 'str', 'required': False, 'allowed_values': ['unpaid', 'partial', 'paid']}, {'name': 'purchase_order', 'type': 'str', 'required': False}, {'name': 'po_party_type', 'type': 'str', 'required': False, 'allowed_values': ['supplier', 'subcontractor']}, {'name': 'amount_due_aed', 'type': 'float', 'required': False, 'min': 0, 'max': 1000000000}, {'name': 'due_on', 'type': 'str', 'required': False, 'format': 'date'}, {'name': 'notes', 'type': 'str', 'required': False}]}, 'document_qa_and_indexing': {'entity': 'document_qa_and_indexing', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'document_title', 'type': 'str', 'required': True}, {'name': 'document_type', 'type': 'str', 'required': True, 'allowed_values': ['boq', 'drawing', 'method_statement', 'safety_procedure', 'price_list', 'subcontract', 'other']}, {'name': 'job_code', 'type': 'str', 'required': False}, {'name': 'revision', 'type': 'str', 'required': False}, {'name': 'file_name', 'type': 'str', 'required': False}, {'name': 'file_path', 'type': 'str', 'required': False}, {'name': 'file_sha256', 'type': 'str', 'required': False}, {'name': 'question', 'type': 'str', 'required': False}, {'name': 'answer', 'type': 'str', 'required': False}, {'name': 'source_reference', 'type': 'str', 'required': False}, {'name': 'indexed_at', 'type': 'str', 'required': False, 'format': 'datetime'}, {'name': 'notes', 'type': 'str', 'required': False}]}, 'safety_and_compliance': {'entity': 'safety_and_compliance', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'job_code', 'type': 'str', 'required': True}, {'name': 'document_title', 'type': 'str', 'required': True}, {'name': 'method_statement_ref', 'type': 'str', 'required': False}, {'name': 'work_front', 'type': 'str', 'required': False}, {'name': 'checklist_item', 'type': 'str', 'required': False}, {'name': 'checklist_state', 'type': 'str', 'required': False, 'allowed_values': ['met', 'unmet']}, {'name': 'readiness_gate', 'type': 'str', 'required': False, 'allowed_values': ['ready', 'blocked', 'not_assessed']}, {'name': 'incident_type', 'type': 'str', 'required': False, 'allowed_values': ['near_miss', 'incident', 'hazard']}, {'name': 'incident_date', 'type': 'str', 'required': False, 'format': 'date'}, {'name': 'severity', 'type': 'str', 'required': False, 'allowed_values': ['low', 'medium', 'high']}, {'name': 'action_taken', 'type': 'str', 'required': False}, {'name': 'notes', 'type': 'str', 'required': False}]}, 'progress_cost_dashboard': {'entity': 'progress_cost_dashboard', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'report_date', 'type': 'str', 'required': True, 'format': 'date'}, {'name': 'job_code', 'type': 'str', 'required': True}, {'name': 'progress_percent', 'type': 'float', 'required': False, 'min': 0, 'max': 100}, {'name': 'certified_value_aed', 'type': 'float', 'required': False, 'min': 0, 'max': 1000000000}, {'name': 'cost_to_date_aed', 'type': 'float', 'required': False, 'min': 0, 'max': 1000000000}, {'name': 'variations_pending', 'type': 'int', 'required': False, 'min': 0, 'max': 10000}, {'name': 'snags_open', 'type': 'int', 'required': False, 'min': 0, 'max': 10000}, {'name': 'payments_due_aed', 'type': 'float', 'required': False, 'min': 0, 'max': 1000000000}, {'name': 'margin_percent', 'type': 'float', 'required': False, 'min': -100, 'max': 100}, {'name': 'summary', 'type': 'str', 'required': False}]}, 'automation_reminders_escalation': {'entity': 'automation_reminders_escalation', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'job_code', 'type': 'str', 'required': True}, {'name': 'reminder_type', 'type': 'str', 'required': True, 'allowed_values': ['valuation_due', 'variation_escalation', 'snag_escalation', 'overdue_payment']}, {'name': 'due_date', 'type': 'str', 'required': False, 'format': 'date'}, {'name': 'threshold_count', 'type': 'int', 'required': False, 'min': 0, 'max': 10000}, {'name': 'actual_count', 'type': 'int', 'required': False, 'min': 0, 'max': 10000}, {'name': 'escalation_state', 'type': 'str', 'required': False, 'allowed_values': ['none', 'flagged', 'escalated']}, {'name': 'channel', 'type': 'str', 'required': False, 'allowed_values': ['email', 'webhook', 'slack']}, {'name': 'recipient_email', 'type': 'str', 'required': False}, {'name': 'message_body', 'type': 'str', 'required': False}, {'name': 'schedule', 'type': 'str', 'required': False, 'allowed_values': ['monthly', 'weekly', 'daily']}, {'name': 'summary', 'type': 'str', 'required': False}]}, 'audit_and_access_control': {'entity': 'audit_and_access_control', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'actor_name', 'type': 'str', 'required': True}, {'name': 'actor_role', 'type': 'str', 'required': True, 'allowed_values': ['owner', 'site_engineer', 'accounts', 'admin']}, {'name': 'action_type', 'type': 'str', 'required': True, 'allowed_values': ['approval', 'document_version', 'financial_change', 'access_grant', 'access_revoke']}, {'name': 'entity_name', 'type': 'str', 'required': False}, {'name': 'entity_reference', 'type': 'str', 'required': False}, {'name': 'change_summary', 'type': 'str', 'required': False}, {'name': 'approval_state', 'type': 'str', 'required': False, 'allowed_values': ['pending', 'approved', 'rejected']}, {'name': 'occurred_at', 'type': 'str', 'required': False, 'format': 'datetime'}, {'name': 'notes', 'type': 'str', 'required': False}]}, 'team_notifications': {'entity': 'team_notifications', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'recipient_email', 'type': 'str', 'required': False}, {'name': 'recipient_role', 'type': 'str', 'required': False, 'allowed_values': ['owner', 'site_engineer', 'accounts']}, {'name': 'channel', 'type': 'str', 'required': False, 'allowed_values': ['email', 'slack', 'webhook']}, {'name': 'subject', 'type': 'str', 'required': True}, {'name': 'message_body', 'type': 'str', 'required': True}, {'name': 'notification_type', 'type': 'str', 'required': False, 'allowed_values': ['approval', 'valuation_due', 'overdue_item', 'snag']}, {'name': 'related_reference', 'type': 'str', 'required': False}, {'name': 'send_at', 'type': 'str', 'required': False, 'format': 'datetime'}, {'name': 'delivery_state', 'type': 'str', 'required': False, 'allowed_values': ['queued', 'sent', 'skipped']}]}}
DEFAULT_CAPABILITY = 'job_and_site_tracking'
DEFAULT_ENTITY = 'job_and_site_tracking'
SAMPLE = {'reference': 'sample', 'status': 'open', 'job_code': 'sample', 'job_name': 'sample', 'site_name': 'sample', 'client_name': 'sample', 'work_front': 'sample', 'contract_value_aed': 0.0, 'progress_percent': 0.0, 'milestone': 'sample', 'milestone_due_date': '2026-09-03', 'snag_open_count': 0, 'variation_reference': 'sample', 'variation_status': 'draft', 'notes': 'sample'}
