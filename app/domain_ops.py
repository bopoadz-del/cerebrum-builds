...
SPECS: Dict[str, Dict[str, Any]] = {'branch_and_consolidated_operations': {'entity': 'branch_and_consolidated_operations', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'branch', 'type': 'str', 'required': True}, {'name': 'role_view', 'type': 'str', 'required': True}, {'name': 'view_scope', 'type': 'str', 'required': False}, {'name': 'period', 'type': 'str', 'required': False}, {'name': 'metrics_summary', 'type': 'str', 'required': False}, {'name': 'notes', 'type': 'str', 'required': False}]}, 'inventory_and_replenishment': {'entity': 'inventory_and_replenishment', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'branch', 'type': 'str', 'required': True}, {'name': 'item_name', 'type': 'str', 'required': True}, {'name': 'item_type', 'type': 'str', 'required': True, 'allowed_values': ['ingredient', 'finished_good']}, {'name': 'quantity_on_hand', 'type': 'int', 'required': False, 'min': 0}, {'name': 'reorder_threshold', 'type': 'int', 'required': False, 'min': 0}, {'name': 'unit', 'type': 'str', 'required': False}, {'name': 'supplier', 'type': 'str', 'required': False}, {'name': 'transfer_to_branch', 'type': 'str', 'required': False}, {'name': 'low_stock', 'type': 'bool', 'required': False}]}, 'branch_books_and_accounting': {'entity': 'branch_books_and_accounting', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'branch', 'type': 'str', 'required': True}, {'name': 'entry_type', 'type': 'str', 'required': True, 'allowed_values': ['sale', 'cost', 'expense', 'taking', 'price_list']}, {'name': 'entry_date', 'type': 'date', 'required': False}, {'name': 'amount', 'type': 'float', 'required': False, 'min': 0}, {'name': 'margin_percent', 'type': 'float', 'required': False, 'min': 0}, {'name': 'ingredient', 'type': 'str', 'required': False}, {'name': 'notes', 'type': 'str', 'required': False}]}, 'delivery_and_dispatch': {'entity': 'delivery_and_dispatch', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'branch', 'type': 'str', 'required': True}, {'name': 'driver', 'type': 'str', 'required': True}, {'name': 'vehicle_type', 'type': 'str', 'required': True, 'allowed_values': ['car', 'bike']}, {'name': 'vehicle_code', 'type': 'str', 'required': False}, {'name': 'delivery_zone', 'type': 'str', 'required': False}, {'name': 'route', 'type': 'str', 'required': False}, {'name': 'order_reference', 'type': 'str', 'required': False}, {'name': 'proof_of_delivery', 'type': 'str', 'required': False}, {'name': 'scheduled_at', 'type': 'datetime', 'required': False}]}, 'order_follow_up': {'entity': 'order_follow_up', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'branch', 'type': 'str', 'required': True}, {'name': 'channel', 'type': 'str', 'required': True, 'allowed_values': ['email', 'phone', 'counter', 'outlook']}, {'name': 'customer_name', 'type': 'str', 'required': True}, {'name': 'order_status', 'type': 'str', 'required': False}, {'name': 'payment_status', 'type': 'str', 'required': False, 'allowed_values': ['unpaid', 'paid', 'partial']}, {'name': 'confirmed', 'type': 'bool', 'required': False}, {'name': 'due_at', 'type': 'datetime', 'required': False}, {'name': 'follow_up_note', 'type': 'str', 'required': False}]}, 'events_supply': {'entity': 'events_supply', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'branch', 'type': 'str', 'required': True}, {'name': 'event_name', 'type': 'str', 'required': True}, {'name': 'event_date', 'type': 'date', 'required': False}, {'name': 'guest_count', 'type': 'int', 'required': False, 'min': 1}, {'name': 'deposit_amount', 'type': 'float', 'required': False, 'min': 0}, {'name': 'delivery_time', 'type': 'str', 'required': False}, {'name': 'venue', 'type': 'str', 'required': False}, {'name': 'contact_email', 'type': 'str', 'required': False}]}, 'document_grounded_knowledge': {'entity': 'document_grounded_knowledge', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'branch', 'type': 'str', 'required': True}, {'name': 'question', 'type': 'str', 'required': True}, {'name': 'document_type', 'type': 'str', 'required': True, 'allowed_values': ['price_list', 'recipe', 'ingredient_cost', 'delivery_zone', 'supplier_list', 'procedure']}, {'name': 'answer', 'type': 'str', 'required': False}, {'name': 'citations', 'type': 'str', 'required': False}, {'name': 'confidence', 'type': 'float', 'required': False, 'min': 0}]}, 'outlook_branch_messaging_integration': {'entity': 'outlook_branch_messaging_integration', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'branch', 'type': 'str', 'required': True}, {'name': 'mailbox', 'type': 'str', 'required': True}, {'name': 'direction', 'type': 'str', 'required': True, 'allowed_values': ['inbound', 'outbound']}, {'name': 'subject', 'type': 'str', 'required': False}, {'name': 'body', 'type': 'str', 'required': False}, {'name': 'message_reference', 'type': 'str', 'required': False}, {'name': 'received_at', 'type': 'datetime', 'required': False}]}}
DEFAULT_CAPABILITY = 'branch_and_consolidated_operations'
DEFAULT_ENTITY = 'branch_and_consolidated_operations'
SAMPLE = {'reference': 's10-row', 'status': 'open', 'branch': 's10-row', 'role_view': 's10-row', 'view_scope': 's10-row', 'period': 's10-row', 'metrics_summary': 's10-row', 'notes': 's10-row'}
