...
SPECS: Dict[str, Dict[str, Any]] = {'lead_intake_and_dial_queue': {'entity': 'lead_intake_and_dial_queue', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'lead_name', 'type': 'str', 'required': True}, {'name': 'phone', 'type': 'str', 'required': True}, {'name': 'language', 'type': 'str', 'required': True, 'allowed_values': ['en', 'ar']}, {'name': 'project_tag', 'type': 'str', 'required': True}, {'name': 'source_file', 'type': 'str', 'required': False}, {'name': 'call_window', 'type': 'str', 'required': False}, {'name': 'daily_call_cap', 'type': 'int', 'required': False, 'min': 1, 'max': 100000}, {'name': 'concurrency', 'type': 'int', 'required': False, 'min': 1, 'max': 50}, {'name': 'attempt_count', 'type': 'int', 'required': False, 'min': 0, 'max': 3}, {'name': 'retry_backoff_minutes', 'type': 'int', 'required': False, 'min': 0, 'max': 1440}, {'name': 'queue_status', 'type': 'str', 'required': False, 'allowed_values': ['queued', 'dialing', 'paused', 'exhausted']}, {'name': 'notes', 'type': 'str', 'required': False}]}, 'call_state_machine': {'entity': 'call_state_machine', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'call_sid', 'type': 'str', 'required': True}, {'name': 'lead_name', 'type': 'str', 'required': False}, {'name': 'phone', 'type': 'str', 'required': False}, {'name': 'current_state', 'type': 'str', 'required': True, 'allowed_values': ['queued', 'dialing', 'answered', 'pitched', 'qualified', 'transferred', 'callback', 'closed']}, {'name': 'previous_state', 'type': 'str', 'required': False, 'allowed_values': ['queued', 'dialing', 'answered', 'pitched', 'qualified', 'transferred', 'callback', 'closed']}, {'name': 'call_window', 'type': 'str', 'required': False}, {'name': 'window_state', 'type': 'str', 'required': False, 'allowed_values': ['open', 'closed']}, {'name': 'transition_event', 'type': 'str', 'required': False}, {'name': 'attempt_count', 'type': 'int', 'required': False, 'min': 0, 'max': 3}, {'name': 'notes', 'type': 'str', 'required': False}]}, 'project_knowledge_grounding': {'entity': 'project_knowledge_grounding', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'project_tag', 'type': 'str', 'required': True}, {'name': 'claim_type', 'type': 'str', 'required': True, 'allowed_values': ['price', 'payment_plan', 'handover_date', 'other']}, {'name': 'question', 'type': 'str', 'required': True}, {'name': 'document_name', 'type': 'str', 'required': False}, {'name': 'document_text', 'type': 'str', 'required': False}, {'name': 'citation', 'type': 'str', 'required': False}, {'name': 'authority_label', 'type': 'str', 'required': False, 'allowed_values': ['certified', 'documents', 'formulas', 'procedures']}, {'name': 'grounded', 'type': 'bool', 'required': False}, {'name': 'answer', 'type': 'str', 'required': False}, {'name': 'notes', 'type': 'str', 'required': False}]}, 'voice_gateway': {'entity': 'voice_gateway', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'call_sid', 'type': 'str', 'required': False}, {'name': 'direction', 'type': 'str', 'required': False, 'allowed_values': ['outbound', 'inbound']}, {'name': 'to_number', 'type': 'str', 'required': False}, {'name': 'from_number', 'type': 'str', 'required': False}, {'name': 'language', 'type': 'str', 'required': True, 'allowed_values': ['en', 'ar']}, {'name': 'voice', 'type': 'str', 'required': False}, {'name': 'asr_engine', 'type': 'str', 'required': False, 'allowed_values': ['twilio_gather_speech']}, {'name': 'twilio_mode', 'type': 'str', 'required': False, 'allowed_values': ['stubbed', 'live']}, {'name': 'call_status', 'type': 'str', 'required': False, 'allowed_values': ['initiated', 'ringing', 'answered', 'completed', 'failed', 'busy', 'no-answer']}, {'name': 'twiml', 'type': 'str', 'required': False}, {'name': 'recording_url', 'type': 'str', 'required': False}, {'name': 'notes', 'type': 'str', 'required': False}]}, 'warm_transfer': {'entity': 'warm_transfer', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'call_sid', 'type': 'str', 'required': True}, {'name': 'lead_name', 'type': 'str', 'required': False}, {'name': 'outcome', 'type': 'str', 'required': True, 'allowed_values': ['project_interested', 'other_re_interested', 'not_interested']}, {'name': 'broker_number', 'type': 'str', 'required': False}, {'name': 'conference_name', 'type': 'str', 'required': False}, {'name': 'summary', 'type': 'str', 'required': True}, {'name': 'whisper_text', 'type': 'str', 'required': False}, {'name': 'transfer_status', 'type': 'str', 'required': False, 'allowed_values': ['initiated', 'bridged', 'failed', 'declined']}, {'name': 'whisper_delivered', 'type': 'bool', 'required': False}, {'name': 'notes', 'type': 'str', 'required': False}]}, 'qualification_and_broker_summary': {'entity': 'qualification_and_broker_summary', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'call_sid', 'type': 'str', 'required': True}, {'name': 'lead_name', 'type': 'str', 'required': False}, {'name': 'outcome', 'type': 'str', 'required': True, 'allowed_values': ['project_interested', 'other_re_interested', 'not_interested']}, {'name': 'property_type', 'type': 'str', 'required': False, 'allowed_values': ['apartment', 'villa', 'townhouse', 'plot', 'office']}, {'name': 'budget', 'type': 'float', 'required': False, 'min': 0.0}, {'name': 'area', 'type': 'str', 'required': False}, {'name': 'timeline', 'type': 'str', 'required': False}, {'name': 'currency_setting', 'type': 'str', 'required': False}, {'name': 'broker_summary', 'type': 'str', 'required': False}, {'name': 'recommended_action', 'type': 'str', 'required': False}, {'name': 'notes', 'type': 'str', 'required': False}]}, 'outcome_capture_and_ledger': {'entity': 'outcome_capture_and_ledger', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'call_sid', 'type': 'str', 'required': True}, {'name': 'campaign', 'type': 'str', 'required': False}, {'name': 'event_type', 'type': 'str', 'required': True, 'allowed_values': ['attempt', 'answer', 'outcome', 'transfer', 'disposition']}, {'name': 'outcome', 'type': 'str', 'required': False, 'allowed_values': ['project_interested', 'other_re_interested', 'not_interested']}, {'name': 'attempt_count', 'type': 'int', 'required': False, 'min': 0, 'max': 3}, {'name': 'ledger_index', 'type': 'int', 'required': False, 'min': 0}, {'name': 'vector_clock', 'type': 'str', 'required': False}, {'name': 'notes', 'type': 'str', 'required': False}]}, 'crm_destination_placeholder': {'entity': 'crm_destination_placeholder', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'crm_system', 'type': 'str', 'required': True, 'allowed_values': ['unstated', 'salesforce', 'hubspot', 'zoho']}, {'name': 'destination_url', 'type': 'str', 'required': False}, {'name': 'payload_shape', 'type': 'str', 'required': False}, {'name': 'delivery_state', 'type': 'str', 'required': False, 'allowed_values': ['queued', 'stubbed', 'refused']}, {'name': 'mock_mode', 'type': 'bool', 'required': False}, {'name': 'notes', 'type': 'str', 'required': False}]}, 'notification': {'entity': 'notification', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'channel', 'type': 'str', 'required': True, 'allowed_values': ['email', 'sms', 'mcp', 'webhook']}, {'name': 'recipient', 'type': 'str', 'required': False}, {'name': 'subject', 'type': 'str', 'required': False}, {'name': 'message', 'type': 'str', 'required': False}, {'name': 'trigger_event', 'type': 'str', 'required': True, 'allowed_values': ['lead_qualified', 'transfer_completed', 'call_failed', 'campaign_summary']}, {'name': 'delivery_state', 'type': 'str', 'required': False, 'allowed_values': ['queued', 'sent', 'failed']}, {'name': 'notes', 'type': 'str', 'required': False}]}, 'local_drive': {'entity': 'local_drive', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'root_path', 'type': 'str', 'required': False}, {'name': 'relative_path', 'type': 'str', 'required': True}, {'name': 'operation', 'type': 'str', 'required': True, 'allowed_values': ['read', 'write', 'list', 'delete']}, {'name': 'bytes_written', 'type': 'int', 'required': False, 'min': 0}, {'name': 'content_preview', 'type': 'str', 'required': False}, {'name': 'notes', 'type': 'str', 'required': False}]}, 'google_drive': {'entity': 'google_drive', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'drive_mode', 'type': 'str', 'required': True, 'allowed_values': ['stubbed', 'live']}, {'name': 'folder_id', 'type': 'str', 'required': False}, {'name': 'file_name', 'type': 'str', 'required': False}, {'name': 'operation', 'type': 'str', 'required': True, 'allowed_values': ['upload', 'download', 'list']}, {'name': 'credential_setting', 'type': 'str', 'required': False}, {'name': 'notes', 'type': 'str', 'required': False}]}, 'mcp_adapter': {'entity': 'mcp_adapter', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'tool_name', 'type': 'str', 'required': False}, {'name': 'catalog_scope', 'type': 'str', 'required': True, 'allowed_values': ['platform', 'vendor', 'tenant']}, {'name': 'request_shape', 'type': 'str', 'required': False}, {'name': 'response_shape', 'type': 'str', 'required': False}, {'name': 'notes', 'type': 'str', 'required': False}]}}
DEFAULT_CAPABILITY = 'lead_intake_and_dial_queue'
DEFAULT_ENTITY = 'lead_intake_and_dial_queue'
SAMPLE = {'reference': 'sample', 'status': 'open', 'lead_name': 'sample', 'phone': 'sample', 'language': 'en', 'project_tag': 'sample', 'source_file': 'sample', 'call_window': 'sample', 'daily_call_cap': 1, 'concurrency': 1, 'attempt_count': 0, 'retry_backoff_minutes': 0, 'queue_status': 'queued', 'notes': 'sample'}
