...
SPECS: Dict[str, Dict[str, Any]] = {'property_and_room_registry': {'entity': 'property_and_room_registry', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'property_name', 'type': 'str', 'required': True}, {'name': 'building', 'type': 'str', 'required': False}, {'name': 'floor', 'type': 'int', 'required': False, 'min': 0, 'max': 200}, {'name': 'room_number', 'type': 'str', 'required': True}, {'name': 'room_type', 'type': 'str', 'required': True, 'allowed_values': ['standard', 'superior', 'deluxe', 'suite', 'accessible']}, {'name': 'capacity', 'type': 'int', 'required': False, 'min': 1, 'max': 12}, {'name': 'room_status', 'type': 'str', 'required': True, 'allowed_values': ['available', 'occupied', 'dirty', 'cleaned', 'out_of_order']}, {'name': 'notes', 'type': 'str', 'required': False}]}, 'front_desk_and_guest_stay': {'entity': 'front_desk_and_guest_stay', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'guest_name', 'type': 'str', 'required': True}, {'name': 'room_number', 'type': 'str', 'required': True}, {'name': 'arrival_date', 'type': 'str', 'required': True}, {'name': 'departure_date', 'type': 'str', 'required': False}, {'name': 'guests_count', 'type': 'int', 'required': False, 'min': 1, 'max': 10}, {'name': 'stay_status', 'type': 'str', 'required': True, 'allowed_values': ['reserved', 'checked_in', 'checked_out', 'no_show', 'cancelled']}, {'name': 'folio_currency', 'type': 'str', 'required': False}, {'name': 'notes', 'type': 'str', 'required': False}]}, 'housekeeping_and_maintenance': {'entity': 'housekeeping_and_maintenance', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'title', 'type': 'str', 'required': True}, {'name': 'work_type', 'type': 'str', 'required': True, 'allowed_values': ['housekeeping', 'maintenance', 'inspection']}, {'name': 'room_number', 'type': 'str', 'required': True}, {'name': 'priority', 'type': 'str', 'required': True, 'allowed_values': ['low', 'normal', 'high', 'urgent']}, {'name': 'due_date', 'type': 'str', 'required': False}, {'name': 'assigned_to', 'type': 'str', 'required': False}, {'name': 'work_status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'assigned', 'in_progress', 'done', 'cancelled']}, {'name': 'notes', 'type': 'str', 'required': False}]}, 'guest_engagement_and_segmentation': {'entity': 'guest_engagement_and_segmentation', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'guest_name', 'type': 'str', 'required': True}, {'name': 'recency_days', 'type': 'int', 'required': True, 'min': 0, 'max': 3650}, {'name': 'frequency', 'type': 'int', 'required': True, 'min': 0, 'max': 1000}, {'name': 'monetary', 'type': 'float', 'required': True, 'min': 0.0, 'max': 1000000.0}, {'name': 'segment', 'type': 'str', 'required': False, 'allowed_values': ['champion', 'loyal', 'potential', 'at_risk', 'dormant']}, {'name': 'delivery_channel', 'type': 'str', 'required': True, 'allowed_values': ['mcp', 'email']}, {'name': 'offer_code', 'type': 'str', 'required': False}, {'name': 'notes', 'type': 'str', 'required': False}]}, 'document_and_knowledge_answers': {'entity': 'document_and_knowledge_answers', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'title', 'type': 'str', 'required': True}, {'name': 'document_kind', 'type': 'str', 'required': True, 'allowed_values': ['manual', 'sop', 'rate_sheet', 'policy', 'other']}, {'name': 'question', 'type': 'str', 'required': True}, {'name': 'document_text', 'type': 'str', 'required': True}, {'name': 'attachment_path', 'type': 'str', 'required': False}, {'name': 'answer', 'type': 'str', 'required': False}, {'name': 'source_document', 'type': 'str', 'required': False}, {'name': 'authority_label', 'type': 'str', 'required': False, 'allowed_values': ['certified', 'documents', 'formulas', 'procedures']}, {'name': 'notes', 'type': 'str', 'required': False}]}, 'operations_billing': {'entity': 'operations_billing', 'fields': [{'name': 'setting', 'type': 'str', 'required': True}, {'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'folio_reference', 'type': 'str', 'required': True}, {'name': 'charge_type', 'type': 'str', 'required': True, 'allowed_values': ['room', 'food_and_beverage', 'spa', 'minibar', 'laundry', 'other']}, {'name': 'amount', 'type': 'float', 'required': True, 'min': 0.0, 'max': 1000000.0}, {'name': 'currency', 'type': 'str', 'required': False}, {'name': 'tax_rate_percent', 'type': 'float', 'required': False, 'min': 0.0, 'max': 100.0}, {'name': 'total_amount', 'type': 'float', 'required': False, 'min': 0.0}, {'name': 'notes', 'type': 'str', 'required': False}]}, 'operations_oversight_dashboard': {'entity': 'operations_oversight_dashboard', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'dashboard_name', 'type': 'str', 'required': True}, {'name': 'widget', 'type': 'str', 'required': True, 'allowed_values': ['occupancy', 'room_status', 'work_orders', 'guest_activity']}, {'name': 'window_days', 'type': 'int', 'required': False, 'min': 1, 'max': 90}, {'name': 'operator_role', 'type': 'str', 'required': True, 'allowed_values': ['operator', 'admin']}, {'name': 'occupancy_percent', 'type': 'float', 'required': False, 'min': 0.0, 'max': 100.0}, {'name': 'open_work_orders', 'type': 'int', 'required': False, 'min': 0, 'max': 10000}, {'name': 'notes', 'type': 'str', 'required': False}]}, 'external_integration_adapter': {'entity': 'external_integration_adapter', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'system', 'type': 'str', 'required': True, 'allowed_values': ['opera', 'micros', 'maximo', 'loyalty_lms', 'grms', 'gaming_cms']}, {'name': 'resource', 'type': 'str', 'required': True}, {'name': 'direction', 'type': 'str', 'required': True, 'allowed_values': ['inbound', 'outbound']}, {'name': 'payload_format', 'type': 'str', 'required': True, 'allowed_values': ['json', 'csv', 'xml']}, {'name': 'endpoint_url', 'type': 'str', 'required': False}, {'name': 'records_seen', 'type': 'int', 'required': False, 'min': 0}, {'name': 'notes', 'type': 'str', 'required': False}]}}
DEFAULT_CAPABILITY = 'document_and_knowledge_answers'
DEFAULT_ENTITY = 'document_and_knowledge_answers'
SAMPLE = {'reference': 's10-row', 'status': 'open', 'title': 's10-row', 'document_kind': 'manual', 'question': 's10-row', 'document_text': 's10-row', 'attachment_path': 's10-row', 'answer': 's10-row', 'source_document': 's10-row', 'authority_label': 'certified', 'notes': 's10-row'}
