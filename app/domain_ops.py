...
SPECS: Dict[str, Dict[str, Any]] = {'record_guest_check_in': {'entity': 'record_guest_check_in', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'guest_name', 'type': 'str', 'required': True}, {'name': 'room_number', 'type': 'str', 'required': True}, {'name': 'checked_in_at', 'type': 'datetime', 'required': False}, {'name': 'guests_count', 'type': 'int', 'required': False, 'min': 1, 'max': 20}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'notes', 'type': 'str', 'required': False}]}, 'list_todays_check_ins': {'entity': 'list_todays_check_ins', 'fields': [{'name': 'reference', 'type': 'str', 'required': True}, {'name': 'check_in_date', 'type': 'date', 'required': True}, {'name': 'room_number', 'type': 'str', 'required': True}, {'name': 'guest_name', 'type': 'str', 'required': True}, {'name': 'check_in_count', 'type': 'int', 'required': False, 'min': 0, 'max': 500}, {'name': 'status', 'type': 'str', 'required': True, 'allowed_values': ['open', 'in_progress', 'closed']}, {'name': 'notes', 'type': 'str', 'required': False}]}}
DEFAULT_CAPABILITY = 'record_guest_check_in'
DEFAULT_ENTITY = 'record_guest_check_in'
SAMPLE = {'reference': 'sample', 'guest_name': 'sample', 'room_number': 'sample', 'checked_in_at': '2026-09-03T10:00:00', 'guests_count': 1, 'status': 'open', 'notes': 'sample'}
