...
CAPABILITIES: List[Dict[str, Any]] = [
    ...
    {"id": "document_knowledge_qa", "entity": "document_knowledge_qa",
     "blocks": ['document_engine', 'knowledge', 'vector_search', 'storage', 'memory', 'spec_analyzer']},
    {"id": "fleet_cost_and_pricing", "entity": "fleet_cost_and_pricing",
     "blocks": ['formula_executor', 'database', 'portfolio_rollup', 'analytics', 'validation']},
    ...
    {"id": "operational_procedures_readiness", "entity": "operational_procedures_readiness",
     "blocks": ['readiness_engine', 'workflow', 'knowledge', 'notification', 'validation']},
    {"id": "audit_evidence_trail", "entity": "audit_evidence_trail",
     "blocks": ['audit', 'evidence_verifier', 'file_hasher', 'database', 'storage']},
]
