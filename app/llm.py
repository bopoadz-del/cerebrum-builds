"""LLM access for LexManage — offline by posture, loud when unconfigured.
...
extractive summariser (:func:`summarize`) and the firm's own corpus
...
PROVIDER_ENV = "LEXMANAGE_LLM_PROVIDER"
LEGACY_PROVIDER_ENV = "CEREBRUM_LLM_PROVIDER"
API_KEY_ENV = "LEXMANAGE_LLM_API_KEY"
