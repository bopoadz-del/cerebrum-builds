...
app = FastAPI(title="Bakery Branch Operations Platform", lifespan=lifespan)
install_observability(app)
app.include_router(router, prefix="/v1")
# Document surfaces served by app.rag_routes (mounted below, no prefix):
...
def ui_root():
    ...
    return HTMLResponse("<!doctype html><html><body><h1>Bakery Branch Operations Platform</h1></body></html>")
