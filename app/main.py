"""Cerebrum FinanceOps FastAPI entry. Bind 0.0.0.0:$PORT on Render."""
...
app = FastAPI(
    title="Finance Ops Platform",
    version="1.0.0",
    description="Cerebrum FinanceOps — FP&A foundation for a mid-market finance team",
    lifespan=lifespan,
)
