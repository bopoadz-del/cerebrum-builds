...
from app.observe import install_request_logging
...
app = FastAPI(
    ...
    version="1.0.0",
    description=(
        "Cerebrum Productivity Platform — a tiny notes app for productivity operators. "
        "Save a note with a title and body, list notes, search by keyword, delete a note. "
