"""Cerebrum Small Retail Inventory FastAPI entry. Bind 0.0.0.0:$PORT on Render."""
...
app = FastAPI(
    title="Small Retail Inventory Platform",
    version="1.0.0",
    description="Cerebrum Small Retail Inventory — SKU catalog, stock, receive/sell, reorder",
    lifespan=lifespan,
)
