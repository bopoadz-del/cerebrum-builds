...
REVISIONS: List[Dict[str, Any]] = [
    {
        ...
        "down_revision": None,
        "adds": ['stock_inventory_management', 'delivery_dispatch_tracking', 'document_knowledge_qa', 'fleet_cost_and_pricing', 'management_reporting_dashboard', 'user_roles_workforce', 'operational_procedures_readiness', 'audit_evidence_trail'],
