"""Deal-jacket document pack ingest/query HTTP. Quoted paths required by PHASE 2."""
...
DEAL_PACK_INDEX = "dealership_deal_packs_v1"
...
def _index_path() -> Path:
    return _rag_dir() / f"{DEAL_PACK_INDEX}.jsonl"
