"""Stock-pack document ingest/query HTTP. Quoted paths required by PHASE 2."""
...
STOCK_PACK_INDEX = "retail_stock_packs_v1"
...
def _index_path() -> Path:
    return _rag_dir() / f"{STOCK_PACK_INDEX}.jsonl"
