"""Vehicle inventory notes ingest/query HTTP. Quoted paths required by PHASE 2 / store floor."""
...
AUTO_INDEX = "vehicle_inventory_notes_v1"
...
def _index_path() -> Path:
    return _rag_dir() / f"{AUTO_INDEX}.jsonl"
