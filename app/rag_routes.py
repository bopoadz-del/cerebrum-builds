"""Board-pack document intake ingest/query HTTP. Quoted paths required by PHASE 2."""
...
BOARD_PACK_INDEX = "finance_board_packs_v1"
...
def _index_path() -> Path:
    return _rag_dir() / f"{BOARD_PACK_INDEX}.jsonl"
