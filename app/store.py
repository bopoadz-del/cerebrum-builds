...
TABLES: Tuple[str, ...] = ('budget_planning_tracking', 'spend_capture_categorisation', 'approval_workflow', 'variance_analytics', 'dashboard_portfolio_rollup', 'audit_evidence_validation', 'finance_document_knowledge', 'integrations_placeholders')
COLUMNS: Dict[str, List[str]] = {'budget_planning_tracking': ['reference', 'status', 'department', 'budget_owner', 'cost_centre', 'period', 'planned_amount', 'actual_amount', 'currency', 'notes'], 'spend_capture_categorisation': ['reference', 'status', 'department', 'supplier', 'category', 'amount', 'currency', 'invoice_date', 'invoice_number', 'document_path', 'notes'], 'approval_workflow': ['reference', 'status', 'department', 'request_type', 'approver', 'approver_email', 'amount', 'threshold', 'priority', 'submitted_at', 'notes'], 'variance_analytics': ['reference', 'status', 'department', 'category', 'period', 'budget_amount', 'actual_amount', 'formula', 'notes'], 'dashboard_portfolio_rollup': ['reference', 'status', 'department', 'role_view', 'view_scope', 'period', 'spend_total', 'commitment_total', 'forecast_total', 'risk_level', 'notes'], 'audit_evidence_validation': ['reference', 'status', 'department', 'record_type', 'record_reference', 'evidence_hash', 'verified', 'checked_at', 'notes'], 'finance_document_knowledge': ['reference', 'status', 'department', 'document_type', 'question', 'answer', 'citations', 'confidence', 'document_path'], 'integrations_placeholders': ['reference', 'status', 'department', 'integration', 'direction', 'detail', 'external_reference', 'last_sync_at', 'notes']}
