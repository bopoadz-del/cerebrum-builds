...
TABLES: Tuple[str, ...] = ('list_todays_check_ins', 'record_guest_check_in')
COLUMNS: Dict[str, List[str]] = {'list_todays_check_ins': ['reference', 'check_in_date', 'room_number', 'guest_name', 'check_in_count', 'status', 'notes'], 'record_guest_check_in': ['reference', 'guest_name', 'room_number', 'checked_in_at', 'guests_count', 'status', 'notes']}
