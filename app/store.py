...
TABLES: Tuple[str, ...] = ('inventory_management', 'sales_and_orders', 'customer_insights', 'analytics_dashboard', 'supplier_and_purchasing', 'omnichannel_integration', 'compliance_and_audit')
COLUMNS: Dict[str, List[str]] = {'inventory_management': ['reference', 'status', 'sku', 'product_name', 'location', 'quantity_on_hand', 'reorder_point', 'unit_cost', 'supplier_name', 'category', 'movement_type', 'last_counted_date'], 'sales_and_orders': ['reference', 'status', 'order_number', 'customer_name', 'customer_email', 'channel', 'order_total', 'item_count', 'payment_status', 'fulfilment_status', 'order_date', 'notes'], 'customer_insights': ['reference', 'status', 'customer_name', 'customer_email', 'segment', 'lifetime_value', 'orders_count', 'last_purchase_date', 'loyalty_tier', 'preferred_channel', 'insight_summary', 'tags'], 'analytics_dashboard': ['reference', 'status', 'dashboard_name', 'metric_name', 'metric_value', 'period_start', 'period_end', 'store_location', 'widget_type', 'report_format', 'owner', 'generated_at'], 'supplier_and_purchasing': ['reference', 'status', 'supplier_name', 'supplier_email', 'purchase_order_number', 'sku', 'quantity_ordered', 'unit_cost', 'lead_time_days', 'order_date', 'expected_date', 'payment_terms'], 'omnichannel_integration': ['reference', 'status', 'integration_name', 'channel', 'external_order_id', 'sync_direction', 'sync_status', 'sku', 'quantity', 'sync_at', 'marketplace', 'notes'], 'compliance_and_audit': ['reference', 'status', 'control_id', 'regulation', 'event_type', 'actor', 'action_taken', 'evidence_ref', 'file_path', 'findings', 'occurred_at', 'severity']}
