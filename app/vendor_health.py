...
(``app.notify`` outbox, ``app.documents`` rendering) instead of a stub that
...
def report(block_ids: Sequence[str]) -> Dict[str, Any]:
    ...
    return {
        ...
        "degraded_capabilities": {
            "inventory_management": ["notification"],
            "weather_and_risk_alerts": ["notification"],
            "compliance_documentation": ["document_engine"],
        },
        "note": (
