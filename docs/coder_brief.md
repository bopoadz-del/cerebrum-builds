...
Booted hospitality platform: Hotel Front Desk Log.
A minimal front-desk logging tool for small hotels and guesthouses that lets staff record guest check-ins and view the current day's check-ins in a simple, focused interface.

Who it is for: hospitality operators
Roles: operator, admin

Capabilities:
- record_check_in [REUSE]: dual-registered  blocks=['database', 'validation']
...
- record_check_in: REUSE ['database', 'validation'] (verified present in Store registry; handler source factory-grounded persist; emit app/actions/record_check_in.py)
...
- record_check_in: REUSE hole-fill — bind persist / event_bus / BLOCK_DEFAULT_ACTIONS; do not skip because inventory_gaps is empty
...
Verified present: database, validation, database, dashboard
Missing:
...
Domain pack (binding fields):
{
  ...
  "core_business_workflows": [
    "one-record round-trip for record_check_in",
  ...
  "domain_purpose": "A minimal front-desk logging tool for small hotels and guesthouses that lets staff record guest check-ins and view the current day's check-ins in a simple, focused interface.",
  "domain_rules": [
  ...
  "mission": "A minimal front-desk logging tool for small hotels and guesthouses that lets staff record guest check-ins and view the current day's check-ins in a simple, focused interface.",
  "primary_users": [
