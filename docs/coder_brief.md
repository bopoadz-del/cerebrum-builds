...
Booted car_dealership platform: Car Dealership Platform.
Build a car dealership platform: vehicle inventory, sales pipeline, finance/lease quotes, service appointments, customer CRM, and document packs for deals. Kit-backed automotive. Manufacture from Cerebrum-Blocks Store blocks only — never clone an external dealership/FinanceOps/The_Fork product repo. Pilot-ready with tests.

Who it is for: car dealership operators
Roles: operator, admin

Capabilities:
- car_dealership_core [GENERATE]: kernel/template generation (no block ids)  (no block ids — genuine gap)
...
- car_dealership_core: GAP — author this logic (kernel/template generation (no block ids))

WORK ITEMS (C-BRIEF hole-fill; GENERATE gaps plus REUSE that still need handlers):
- car_dealership_core: GENERATE/GAP — author this logic
...
Domain pack (binding fields):
{
  ...
  "core_business_workflows": [
    "one-record round-trip for car_dealership_core",
  ...
  "domain_purpose": "Build a car dealership platform: vehicle inventory, sales pipeline, finance/lease quotes, service appointments, customer CRM, and document packs for deals. Kit-backed automotive. Manufacture from Cerebrum-Blocks Store blocks only \u2014 never clone an external dealership/FinanceOps/The_Fork product repo. Pilot-ready with tests.",
  "domain_rules": [
  ...
  "mission": "Build a car dealership platform: vehicle inventory, sales pipeline, finance/lease quotes, service appointments, customer CRM, and document packs for deals. Kit-backed automotive. Manufacture from Cerebrum-Blocks Store blocks only \u2014 never clone an external dealership/FinanceOps/The_Fork product repo. Pilot-ready with tests.",
  "primary_users": [
    "car dealership operators"
  ],
