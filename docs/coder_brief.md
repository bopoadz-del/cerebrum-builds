...
Booted small_retail_inventory platform: Small Retail Inventory Platform.
Build a small retail inventory platform from Cerebrum-Blocks Store blocks only. Pilot-ready with tests. Never clone an external product repo.

Who it is for: small retail inventory operators
Roles: operator, admin

Capabilities:
- small_retail_inventory_core [GENERATE]: kernel/template generation (no block ids)  (no block ids — genuine gap)
...
- small_retail_inventory_core: GAP — author this logic (kernel/template generation (no block ids))

WORK ITEMS (C-BRIEF hole-fill; GENERATE gaps plus REUSE that still need handlers):
- small_retail_inventory_core: GENERATE/GAP — author this logic
...
Domain pack (binding fields):
{
  ...
  "core_business_workflows": [
    "one-record round-trip for small_retail_inventory_core",
  ...
  "domain_purpose": "Build a small retail inventory platform from Cerebrum-Blocks Store blocks only. Pilot-ready with tests. Never clone an external product repo.",
  "domain_rules": [
  ...
  "mission": "Build a small retail inventory platform from Cerebrum-Blocks Store blocks only. Pilot-ready with tests. Never clone an external product repo.",
  "primary_users": [
    "small retail inventory operators"
  ],
