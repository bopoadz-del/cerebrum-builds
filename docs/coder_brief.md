...
Booted bakery_management platform: Bakery Chain Operations Hub.
A management-only operations platform for a 5-shop bakery chain with its own delivery fleet. It centralises multi-shop stock and inventory, product pricing and unit costs, driver dispatch and delivery tracking for ~30 daily deliveries across 10 bikes and 2 cars, fleet cost tracking, workforce and role management, operational readiness checks, and a full audit evidence trail. It also provides a document knowledge Q&A layer over recipes, cost sheets, price lists and delivery procedures that manage

Who it is for: bakery management operators
Roles: operator, admin

Capabilities:
- stock_inventory_management [REUSE]: dual-registered  blocks=['database', 'validation', 'workflow', 'analytics', 'notification']
- product_pricing [REUSE]: dual-registered  blocks=['database', 'formula_executor', 'validation', 'analytics']
- delivery_dispatch_tracking [REUSE]: dual-registered  blocks=['workflow', 'queue', 'event_bus', 'notification', 'analytics']
- fleet_cost_tracking [REUSE]: dual-registered  blocks=['database', 'analytics', 'validation', 'dashboard']
- management_reporting_dashboard [REUSE]: dual-registered  blocks=['dashboard', 'analytics', 'portfolio_rollup', 'database', 'notification']
- user_roles_workforce [REUSE]: dual-registered  blocks=['team', 'workflow', 'database', 'audit']
- document_knowledge_qa [REUSE]: dual-registered  blocks=['knowledge', 'vector_search', 'storage', 'capture', 'document_engine']
- procedures_readiness_and_audit_trail [REUSE]: dual-registered  blocks=['readiness_engine', 'workflow', 'audit', 'evidence_verifier', 'file_hasher', 'spec_analyzer']
...
- stock_inventory_management: REUSE ['database', 'validation', 'workflow', 'analytics', 'notification'] (verified present in Store registry; handler source factory-grounded persist; emit app/actions/stock_inventory_management.py)
- product_pricing: REUSE ['database', 'formula_executor', 'validation', 'analytics'] (verified present in Store registry; handler source factory-grounded persist; emit app/actions/product_pricing.py)
- delivery_dispatch_tracking: REUSE ['workflow', 'queue', 'event_bus', 'notification', 'analytics'] (verified present in Store registry; handler source factory-grounded event_bus workflow; emit app/actions/delivery_dispatch_tracking.py)
- fleet_cost_tracking: REUSE ['database', 'analytics', 'validation', 'dashboard'] (verified present in Store registry; handler source factory-grounded persist; emit app/actions/fleet_cost_tracking.py)
- management_reporting_dashboard: REUSE ['dashboard', 'analytics', 'portfolio_rollup', 'database', 'notification'] (verified present in Store registry; handler source factory-grounded persist; emit app/actions/management_reporting_dashboard.py)
- user_roles_workforce: REUSE ['team', 'workflow', 'database', 'audit'] (verified present in Store registry; handler source factory-grounded persist; emit app/actions/user_roles_workforce.py)
- document_knowledge_qa: REUSE ['knowledge', 'vector_search', 'storage', 'capture', 'document_engine'] (verified present in Store registry; handler source factory-grounded persist; emit app/actions/document_knowledge_qa.py)
- procedures_readiness_and_audit_trail: REUSE ['readiness_engine', 'workflow', 'audit', 'evidence_verifier', 'file_hasher', 'spec_analyzer'] (verified present in Store registry; handler source factory-grounded persist; emit app/actions/procedures_readiness_and_audit_trail.py)
...
- product_pricing: REUSE hole-fill — bind persist / event_bus / BLOCK_DEFAULT_ACTIONS; do not skip because inventory_gaps is empty
...
- fleet_cost_tracking: REUSE hole-fill — bind persist / event_bus / BLOCK_DEFAULT_ACTIONS; do not skip because inventory_gaps is empty
...
- procedures_readiness_and_audit_trail: REUSE hole-fill — bind persist / event_bus / BLOCK_DEFAULT_ACTIONS; do not skip because inventory_gaps is empty
...
Verified present: database, validation, workflow, analytics, notification, database, formula_executor, validation, analytics, workflow, queue, event_bus, notification, analytics, database, analytics, validation, dashboard, dashboard, analytics, portfolio_rollup, database, notification, team, workflow, database, audit, knowledge, vector_search, storage, capture, document_engine, readiness_engine, workflow, audit, evidence_verifier, file_hasher, spec_analyzer
Missing:
...
Domain pack (binding fields):
{
  ...
  "core_business_workflows": [
    ...
    "one-record round-trip for product_pricing",
    "one-record round-trip for delivery_dispatch_tracking",
    "one-record round-trip for fleet_cost_tracking",
    ...
    "one-record round-trip for procedures_readiness_and_audit_trail"
  ],
  "data_sources": [
  ...
  "domain_purpose": "A management-only operations platform for a 5-shop bakery chain with its own delivery fleet. It centralises multi-shop stock and inventory, product pricing and unit costs, driver dispatch and delivery tracking for ~30 daily deliveries across 10 bikes and 2 cars, fleet cost tracking, workforce and role management, operational readiness checks, and a full audit evidence trail. It also provides a document knowledge Q&A layer over recipes, cost sheets, price lists and delivery procedures that manage",
  "domain_rules": [
  ...
  "mission": "A management-only operations platform for a 5-shop bakery chain with its own delivery fleet. It centralises multi-shop stock and inventory, product pricing and unit costs, driver dispatch and delivery tracking for ~30 daily deliveries across 10 bikes and 2 cars, fleet cost tracking, workforce and role management, operational readiness checks, and a full audit evidence trail. It also provides a document knowledge Q&A layer over recipes, cost sheets, price lists and delivery procedures that manage",
  "primary_users": [
