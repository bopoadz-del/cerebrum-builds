...
Booted construction_management platform: Construction Platform.
A construction management platform for a small civil-works contractor in the UAE, working in AED. It covers day-to-day running of one to five concurrent civil jobs — site records, progress, snags, variations — plus document-backed Q&A over BOQs, drawings, method statements and price lists, and full commercial control: BOQ measurement, interim payment applications and valuations, retention, UAE VAT, purchase orders and payment tracking. It serves a team of three to ten (owner, site engineers/fore

Who it is for: construction management operators
Roles: operator, admin

Capabilities:
- job_and_site_tracking [REUSE]: dual-registered  blocks=['workflow', 'database', 'estate_registry', 'validation']
- commercials_and_valuations [REUSE]: dual-registered  blocks=['formula_executor', 'document_engine', 'database', 'validation']
- document_qa_and_indexing [REUSE]: dual-registered  blocks=['capture', 'storage', 'vector_search', 'knowledge', 'file_hasher']
- safety_and_compliance [REUSE]: dual-registered  blocks=['estate_maintenance', 'readiness_engine', 'workflow', 'validation']
- progress_cost_dashboard [REUSE]: dual-registered  blocks=['portfolio_rollup', 'dashboard', 'analytics']
- automation_reminders_escalation [REUSE]: dual-registered  blocks=['queue', 'event_bus', 'notification', 'workflow', 'recommendation_template']
- audit_and_access_control [REUSE]: dual-registered  blocks=['audit', 'team', 'validation', 'database']
- team_notifications [REUSE]: dual-registered  blocks=['notification', 'event_bus']
...
- job_and_site_tracking: REUSE ['workflow', 'database', 'estate_registry', 'validation'] (verified present in Store registry; handler source factory-grounded persist; emit app/actions/job_and_site_tracking.py)
- commercials_and_valuations: REUSE ['formula_executor', 'document_engine', 'database', 'validation'] (verified present in Store registry; handler source factory-grounded persist; emit app/actions/commercials_and_valuations.py)
- document_qa_and_indexing: REUSE ['capture', 'storage', 'vector_search', 'knowledge', 'file_hasher'] (verified present in Store registry; handler source factory-grounded persist; emit app/actions/document_qa_and_indexing.py)
- safety_and_compliance: REUSE ['estate_maintenance', 'readiness_engine', 'workflow', 'validation'] (verified present in Store registry; handler source factory-grounded persist; emit app/actions/safety_and_compliance.py)
- progress_cost_dashboard: REUSE ['portfolio_rollup', 'dashboard', 'analytics'] (verified present in Store registry; handler source factory-grounded persist; emit app/actions/progress_cost_dashboard.py)
- automation_reminders_escalation: REUSE ['queue', 'event_bus', 'notification', 'workflow', 'recommendation_template'] (verified present in Store registry; handler source factory-grounded event_bus workflow; emit app/actions/automation_reminders_escalation.py)
- audit_and_access_control: REUSE ['audit', 'team', 'validation', 'database'] (verified present in Store registry; handler source factory-grounded persist; emit app/actions/audit_and_access_control.py)
- team_notifications: REUSE ['notification', 'event_bus'] (verified present in Store registry; handler source factory-grounded event_bus workflow; emit app/actions/team_notifications.py)

GAPS (you author; do not invent a block id):
- (none)

WORK ITEMS (C-BRIEF hole-fill; GENERATE gaps plus REUSE that still need handlers):
- job_and_site_tracking: REUSE hole-fill — bind persist / event_bus / BLOCK_DEFAULT_ACTIONS; do not skip because inventory_gaps is empty
- commercials_and_valuations: REUSE hole-fill — bind persist / event_bus / BLOCK_DEFAULT_ACTIONS; do not skip because inventory_gaps is empty
- document_qa_and_indexing: REUSE hole-fill — bind persist / event_bus / BLOCK_DEFAULT_ACTIONS; do not skip because inventory_gaps is empty
- safety_and_compliance: REUSE hole-fill — bind persist / event_bus / BLOCK_DEFAULT_ACTIONS; do not skip because inventory_gaps is empty
- progress_cost_dashboard: REUSE hole-fill — bind persist / event_bus / BLOCK_DEFAULT_ACTIONS; do not skip because inventory_gaps is empty
- automation_reminders_escalation: REUSE hole-fill — bind persist / event_bus / BLOCK_DEFAULT_ACTIONS; do not skip because inventory_gaps is empty
- audit_and_access_control: REUSE hole-fill — bind persist / event_bus / BLOCK_DEFAULT_ACTIONS; do not skip because inventory_gaps is empty
- team_notifications: REUSE hole-fill — bind persist / event_bus / BLOCK_DEFAULT_ACTIONS; do not skip because inventory_gaps is empty
...
Verified present: workflow, database, estate_registry, validation, formula_executor, document_engine, database, validation, capture, storage, vector_search, knowledge, file_hasher, estate_maintenance, readiness_engine, workflow, validation, portfolio_rollup, dashboard, analytics, queue, event_bus, notification, workflow, recommendation_template, audit, team, validation, database, notification, event_bus
Missing:
...
- estate_registry READS=["{'kind': 'caller', 'scope': 'input'}", "{'kind': 'config', 'scope': 'runtime'}", "{'kind': 'env', 'scope': 'process'}", "{'kind': 'file', 'scope': 'local.read'}"] WRITES=["{'kind': 'caller', 'scope': 'output'}", "{'kind': 'file', 'scope': 'local.write'}"] NEVER=['(none)'] ACCEPTANCE=["{'check': 'refuses or errors when the record id is absent', 'id': 'missing_record_id', 'status': 'refused'}", "{'check': 'rejects a duplicate registry record id', 'id': 'duplicate_id', 'status': 'failed'}", "{'check': 'errors on an unknown record id on read', 'id': 'unknown_record', 'status': 'failed'}", "{'check': 'errors on an unknown or missing action', 'id': 'unknown_action', 'status': 'failed'}"]
...
- estate_maintenance READS=["{'kind': 'caller', 'scope': 'input'}", "{'kind': 'config', 'scope': 'runtime'}"] WRITES=["{'kind': 'caller', 'scope': 'output'}"] NEVER=['(none)'] ACCEPTANCE=["{'check': 'refuses or errors when title is absent on create', 'id': 'missing_title', 'status': 'refused'}", "{'check': 'errors on an unknown work order id', 'id': 'unknown_work_order', 'status': 'failed'}", "{'check': 'errors when a work order id already exists', 'id': 'duplicate_work_order', 'status': 'failed'}", "{'check': 'errors on an unknown or missing action', 'id': 'unknown_action', 'status': 'failed'}"]
- readiness_engine READS=["{'kind': 'caller', 'scope': 'input'}", "{'kind': 'config', 'scope': 'runtime'}"] WRITES=["{'kind': 'caller', 'scope': 'output'}"] NEVER=['(none)'] ACCEPTANCE=["{'check': 'fails the gate when a required checklist item is unmet', 'id': 'unmet_checklist', 'status': 'failed'}", "{'check': 'errors when checklist or state is not well-formed', 'id': 'malformed_input', 'status': 'failed'}", "{'check': 'errors on an unknown or missing action', 'id': 'unknown_action', 'status': 'failed'}"]
...
REUSE records (present/reuse + reads/writes/never/acceptance):
{
  ...
  "estate_maintenance": {
    "acceptance": [
      "{'check': 'refuses or errors when title is absent on create', 'id': 'missing_title', 'status': 'refused'}",
      "{'check': 'errors on an unknown work order id', 'id': 'unknown_work_order', 'status': 'failed'}",
      "{'check': 'errors when a work order id already exists', 'id': 'duplicate_work_order', 'status': 'failed'}",
      "{'check': 'errors on an unknown or missing action', 'id': 'unknown_action', 'status': 'failed'}"
    ],
  ...
  "estate_registry": {
    "acceptance": [
      "{'check': 'refuses or errors when the record id is absent', 'id': 'missing_record_id', 'status': 'refused'}",
      "{'check': 'rejects a duplicate registry record id', 'id': 'duplicate_id', 'status': 'failed'}",
      "{'check': 'errors on an unknown record id on read', 'id': 'unknown_record', 'status': 'failed'}",
      "{'check': 'errors on an unknown or missing action', 'id': 'unknown_action', 'status': 'failed'}"
    ],
  ...
  "readiness_engine": {
    "acceptance": [
      "{'check': 'fails the gate when a required checklist item is unmet', 'id': 'unmet_checklist', 'status': 'failed'}",
      "{'check': 'errors when checklist or state is not well-formed', 'id': 'malformed_input', 'status': 'failed'}",
      "{'check': 'errors on an unknown or missing action', 'id': 'unknown_action', 'status': 'failed'}"
    ],
  ...
  "recommendation_template": {
    "acceptance": [],
    "block_id": "recommendation_template",
    "never": [],
    "present": true,
    "reads": [
      "{'kind': 'caller', 'scope': 'input'}",
...
Domain pack (binding fields):
{
  ...
  "core_business_workflows": [
    "one-record round-trip for job_and_site_tracking",
    "one-record round-trip for commercials_and_valuations",
    "one-record round-trip for document_qa_and_indexing",
    "one-record round-trip for safety_and_compliance",
    "one-record round-trip for progress_cost_dashboard",
    "one-record round-trip for automation_reminders_escalation",
    "one-record round-trip for audit_and_access_control",
    "one-record round-trip for team_notifications"
  ],
  "data_sources": [
  ...
  "domain_purpose": "A construction management platform for a small civil-works contractor in the UAE, working in AED. It covers day-to-day running of one to five concurrent civil jobs \u2014 site records, progress, snags, variations \u2014 plus document-backed Q&A over BOQs, drawings, method statements and price lists, and full commercial control: BOQ measurement, interim payment applications and valuations, retention, UAE VAT, purchase orders and payment tracking. It serves a team of three to ten (owner, site engineers/fore",
  "domain_rules": [
  ...
  "mission": "A construction management platform for a small civil-works contractor in the UAE, working in AED. It covers day-to-day running of one to five concurrent civil jobs \u2014 site records, progress, snags, variations \u2014 plus document-backed Q&A over BOQs, drawings, method statements and price lists, and full commercial control: BOQ measurement, interim payment applications and valuations, retention, UAE VAT, purchase orders and payment tracking. It serves a team of three to ten (owner, site engineers/fore",
  "primary_users": [
    "construction management operators"
  ],
...
- estate_registry: {'check': 'refuses or errors when the record id is absent', 'id': 'missing_record_id', 'status': 'refused'}, {'check': 'rejects a duplicate registry record id', 'id': 'duplicate_id', 'status': 'failed'}, {'check': 'errors on an unknown record id on read', 'id': 'unknown_record', 'status': 'failed'}, {'check': 'errors on an unknown or missing action', 'id': 'unknown_action', 'status': 'failed'}  [check:block_acceptance]
...
- estate_maintenance: {'check': 'refuses or errors when title is absent on create', 'id': 'missing_title', 'status': 'refused'}, {'check': 'errors on an unknown work order id', 'id': 'unknown_work_order', 'status': 'failed'}, {'check': 'errors when a work order id already exists', 'id': 'duplicate_work_order', 'status': 'failed'}, {'check': 'errors on an unknown or missing action', 'id': 'unknown_action', 'status': 'failed'}  [check:block_acceptance]
...
- readiness_engine: {'check': 'fails the gate when a required checklist item is unmet', 'id': 'unmet_checklist', 'status': 'failed'}, {'check': 'errors when checklist or state is not well-formed', 'id': 'malformed_input', 'status': 'failed'}, {'check': 'errors on an unknown or missing action', 'id': 'unknown_action', 'status': 'failed'}  [check:block_acceptance]
...
- HARD RULE: sealed vendor is read-only — do not write vendor/**, vendor_blocks/**, vendor_blocks_mirror/**, blocks.lock.json, build_ledger.jsonl, .git/**, or anything under SEALED_AFTER_CLONER; implement domain in app/** and tests/** only as allowed by ba_allowed_globs / Hybrid C for BA; prefer docs/openapi.json and root openapi.json only — never vendor/**; never patch vendored blocks — call Store blocks via execute(action=)
