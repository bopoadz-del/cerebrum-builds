...
Booted product platform: Product Platform.
Build Cerebrum FinanceOps FP&A for mid-market finance — chart of accounts, budget vs actual. Manufacture from Cerebrum-Blocks Store only.

Who it is for: product operators
Roles: operator, admin

Capabilities:
- product_core [GENERATE]: kernel/template generation (no block ids)  (no block ids — genuine gap)
...
- product_core: GAP — author this logic (kernel/template generation (no block ids))

WORK ITEMS (C-BRIEF hole-fill; GENERATE gaps plus REUSE that still need handlers):
- product_core: GENERATE/GAP — author this logic
...
Domain pack (binding fields):
{
  ...
  "core_business_workflows": [
    "one-record round-trip for product_core",
  ...
  "domain_purpose": "Build Cerebrum FinanceOps FP&A for mid-market finance \u2014 chart of accounts, budget vs actual. Manufacture from Cerebrum-Blocks Store only.",
  "domain_rules": [
  ...
  "mission": "Build Cerebrum FinanceOps FP&A for mid-market finance \u2014 chart of accounts, budget vs actual. Manufacture from Cerebrum-Blocks Store only.",
  "primary_users": [
    "product operators"
  ],
