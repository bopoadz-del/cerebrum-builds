/* DentalDesk Clinic Manager — operator console.
 *
...
const PRODUCT_ID = "dental-clinic";
...
export default function App() {
  ...
  return (
    <main data-product={PRODUCT_ID}>
      <header>
        <h1>DentalDesk Clinic Manager</h1>
        <p>
          Patient visits with tooth-level procedure and fee detail, the front
          desk's appointment book, day-before email reminders and searchable
          clinical history — one four-person practice console.
        </p>
      </header>
      <nav>
        {tabs.map((name) => (
