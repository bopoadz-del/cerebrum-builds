// Document knowledge Q&A — Recipes, cost sheets, price lists and delivery procedures indexed for grounded answers with citations.
...
export default function DocumentKnowledgeQa({ capability }: { capability: CapabilityId }) {
  ...
  return (
    <section>
      <h2>Document knowledge Q&A</h2>
      <p>Recipes, cost sheets, price lists and delivery procedures indexed for grounded answers with citations.</p>
      <label>
        document_title
