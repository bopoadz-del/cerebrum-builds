// Chain dashboard — Consolidates sales, stock, delivery and fleet KPIs across the five bakeries.
// Written by the factory WRITER role (codewhale exec)
import { useState } from "react";
import { create, list, type CapabilityId, type Record } from "../api";

export default function ManagementReportingDashboard({ capability }: { capability: CapabilityId }) {
  ...
  return (
    <section>
      ...
      <p>Consolidates sales, stock, delivery and fleet KPIs across the five bakeries.</p>
      <label>
        metric_name
