...
//: Minimum honest payload per capability: the envelope plus the job's own
...
const INTAKE_FIELDS: Record<string, Record<string, unknown>> = {
  patient_records: { patient_phone: "unrecorded" },
  appointment_scheduling: {
    appointment_type: "exam",
    scheduled_at: "2026-09-20T09:00:00",
  },
  treatment_records: { tooth: "unspecified", procedure: "consultation" },
  recall_reminders: {
    patient_email: "patient@example.com",
    due_date: "2026-09-20",
  },
  invoicing: { treatment_code: "EXAM", amount: 0 },
  staff_roles_permissions: { staff_role: "hygienist" },
  job_dashboard: { dashboard_date: "2026-09-20" },
};
