// Stock board — Tracks per-shop ingredient, product and supply stock and flags reorder shortfalls.
...
export default function StockInventoryManagement({ capability }: { capability: CapabilityId }) {
  ...
  return (
    <section>
      <h2>Stock board</h2>
      <p>Tracks per-shop ingredient, product and supply stock and flags reorder shortfalls.</p>
      <label>
        shop_code
