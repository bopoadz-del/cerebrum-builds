...
def main() -> int:
    ...
    with TestClient(app) as client:
        ...
        missing = client.post("/v1/small_retail_inventory_core", json={"status": "open"})
        results.append(
            _line(
        ...
        bad_enum = client.post(
            "/v1/small_retail_inventory_core", json={"reference": "sample", "status": "bogus"}
        )
        results.append(
            _line(
        ...
        results.append(
            _line(
                "PASS" if ui.status_code == 200 and "Small Retail Inventory Platform" in ui.text else "FAIL",
                "ui_served_200",
        ...
        ingest = client.post(
            ...
            json={
                "layer": 1,
                "doc_id": "acc-pack",
                "title": "Receiving stock close",
                "text": "Receiving ticket and SKU catalog for the retail stock close.",
            },
        )
        query = client.get("/v1/rag/query", params={"q": "receiving stock close"})
        hit = (
