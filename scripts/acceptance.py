...
def check_health_fail_closed() -> Tuple[str, str]:
    # The probe points STORAGE_PATH at a path that does not exist. It is a
    # measurement of THIS process, so the previous value is restored before
    # returning: leaving it broken made the later /health probe read 503 for
    # a reason this check had just manufactured, and the container health
    # line was measuring the harness rather than the platform.
