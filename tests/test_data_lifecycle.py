...
SAMPLE = {'patient_name': 's10-row', 'reference': 's10-row', 'status': 'open'}
...
TENANT = "test-tenant"
ENTITIES = ['appointment_scheduling', 'clinic_dashboard', 'invoicing', 'patient_records', 'recall_reminders', 'staff_roles_permissions', 'treatment_records']
