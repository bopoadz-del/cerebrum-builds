...
SAMPLE = {'call_sid': 's10-row', 'event': 'dial', 'reference': 's10-row', 'status': 'open', 'lead_id': 's10-row', 'lead_reference': 's10-row', 'previous_state': 'queued', 'current_state': 'queued', 'attempt_count': 0, 'within_window': 's10-row', 'window_reason': 's10-row', 'transition_allowed': 's10-row', 'refusal_reason': 's10-row', 'guard_notes': 's10-row', 'window_snapshot': 's10-row', 'occurred_at': 's10-row', 'source': 'voice_gateway', 'campaign': 's10-row'}
...
TENANT = "test-tenant"
ENTITIES = ['call_state_machine', 'crm_destination_placeholder', 'google_drive', 'lead_intake_and_dial_queue', 'local_drive', 'mcp_adapter', 'notification', 'outcome_capture_and_ledger', 'project_knowledge_grounding', 'qualification_and_broker_summary', 'voice_gateway', 'warm_transfer']
