...
SAMPLE = {'pet_name': 's10-row', 'reference': 's10-row', 'status': 'open', 'veterinarian': 's10-row', 'owner_name': 's10-row', 'appointment_date': 's10-row', 'appointment_time': 's10-row', 'duration_minutes': 's10-row', 'visit_reason': 's10-row', 'room': 's10-row', 'appointment_status': 'open'}
ENTITIES = ['appointment_scheduling', 'audit_trail', 'billing_invoicing', 'clinic_analytics', 'inventory_management', 'patient_records', 'role_management', 'treatment_management']
