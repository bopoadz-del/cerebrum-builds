...
SAMPLE = {'appointment_type': 'exam', 'patient_name': 's10-row', 'reference': 's10-row', 'scheduled_at': 's10-row', 'status': 'open', 'patient_email': 's10-row', 'provider': 's10-row', 'chair_room': 's10-row', 'duration_minutes': 's10-row', 'reminder_channel': 'email', 'notes': 's10-row'}
...
TENANT = "test-tenant"
ENTITIES = ['appointment_scheduling', 'clinical_history_search', 'day_before_email_reminders', 'patient_directory', 'patient_visit_records', 'role_based_access', 'todays_appointment_list']
