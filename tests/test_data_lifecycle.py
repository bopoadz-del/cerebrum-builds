...
ENTITY = 'audit_trail'
SAMPLE = {'actor': 's10-row', 'reference': 's10-row', 'status': 'open', 'change_type': 'create', 'subject_capability': 's10-row', 'changed_at': 's10-row'}
...
TENANT = "test-tenant"
ENTITIES = ['audit_trail', 'checkin_notifications', 'daily_checkin_summary', 'guest_notes_and_preferences', 'record_checkin', 'room_availability_check', 'todays_arrivals_board']
