...
SAMPLE = {'action_type': 'approval', 'actor_name': 's10-row', 'actor_role': 'owner', 'reference': 's10-row', 'status': 'open', 'entity_name': 's10-row', 'entity_reference': 's10-row', 'change_summary': 's10-row', 'approval_state': 'pending', 'occurred_at': 's10-row', 'notes': 's10-row'}
...
TENANT = "test-tenant"
ENTITIES = ['audit_and_access_control', 'automation_reminders_escalation', 'commercials_and_valuations', 'document_qa_and_indexing', 'job_and_site_tracking', 'progress_cost_dashboard', 'safety_and_compliance', 'team_notifications']
