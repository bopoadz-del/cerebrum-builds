...
SAMPLE = {'client_name': 's10-row', 'reference': 's10-row', 'status': 'open', 'client_email': 's10-row', 'client_phone': 's10-row', 'matter_type': 's10-row', 'referral_source': 's10-row', 'conflict_check': 's10-row', 'risk_score': 's10-row', 'estimated_fee': 's10-row', 'retainer_amount': 's10-row', 'document_path': 's10-row', 'intake_date': 's10-row'}
ENTITIES = ['client_intake', 'client_portal', 'compliance_audit', 'document_management', 'legal_analytics', 'matter_management', 'time_and_billing']
