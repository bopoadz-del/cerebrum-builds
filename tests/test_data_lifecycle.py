...
ENTITY = 'audit_trail'
SAMPLE = {'audit': 's10-row', 'capture': 's10-row', 'evidence_verifier': 's10-row', 'file_hasher': 's10-row', 'reference': 's10-row', 'status': 'open'}
...
TENANT = "test-tenant"
ENTITIES = ['audit_trail', 'fleet_registry', 'invoicing_and_deposits', 'maintenance_scheduling', 'multi_branch_rollup', 'pricing_and_rate_cards', 'rental_contract_management', 'reporting_analytics']
