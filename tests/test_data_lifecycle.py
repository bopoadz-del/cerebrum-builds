...
SAMPLE = {'metric_name': 's10-row', 'reference': 's10-row', 'report_name': 's10-row', 'status': 'open', 'metric_value': 's10-row', 'period_start': 's10-row', 'period_end': 's10-row', 'appointments_count': 0, 'revenue_total': 's10-row', 'event_type': 's10-row'}
...
TENANT = "test-tenant"
ENTITIES = ['analytics_and_reporting', 'appointment_scheduling', 'billing_and_invoicing', 'client_communication_and_reminders', 'clinical_visit_notes_and_treatment_plans', 'compliance_and_audit_trail', 'patient_and_owner_records', 'vaccination_tracking']
