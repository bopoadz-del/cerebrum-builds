...
SAMPLE = {'check_in_date': 's10-row', 'guest_name': 's10-row', 'reference': 's10-row', 'room_number': 's10-row', 'status': 'open', 'check_in_count': 0, 'notes': 's10-row'}
ENTITIES = ['list_todays_check_ins', 'record_guest_check_in']
