...
TENANT = "test-tenant"
ENTITIES = ['audit_evidence_trail', 'delivery_dispatch_tracking', 'document_knowledge_qa', 'fleet_cost_and_pricing', 'management_reporting_dashboard', 'operational_procedures_readiness', 'stock_inventory_management', 'user_roles_workforce']
