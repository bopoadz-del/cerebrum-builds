...
TENANT = "test-tenant"
ENTITIES = ['document_and_knowledge_answers', 'external_integration_adapter', 'front_desk_and_guest_stay', 'guest_engagement_and_segmentation', 'housekeeping_and_maintenance', 'operations_billing', 'operations_oversight_dashboard', 'property_and_room_registry']
