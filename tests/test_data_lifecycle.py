...
SAMPLE = {'approver': 's10-row', 'department': 's10-row', 'reference': 's10-row', 'request_type': 'invoice', 'status': 'open', 'approver_email': 's10-row', 'amount': 's10-row', 'threshold': 's10-row', 'priority': 'low', 'submitted_at': 's10-row', 'notes': 's10-row'}
...
TENANT = "test-tenant"
ENTITIES = ['approval_workflow', 'audit_evidence_validation', 'budget_planning_tracking', 'dashboard_portfolio_rollup', 'finance_document_knowledge', 'integrations_placeholders', 'spend_capture_categorisation', 'variance_analytics']
