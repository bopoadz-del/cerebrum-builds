...
Wraps vendor.cerebrum.blocks.audit_chain into a synchronous run() function.
"""
import os as _os
...
import asyncio
from vendor.cerebrum.blocks.audit_chain import AuditChainBlock
...
def run(**kwargs):
    instance = _instantiate_store_block(AuditChainBlock)
