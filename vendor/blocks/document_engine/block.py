...
Wraps vendor.cerebrum.blocks.document_engine into a synchronous run() function.
"""
...
def run(**kwargs):
    ...
    """
    block_cls = get_block("document_engine")
    ...
    if envelope.get("status") == "error":
        ...
        raise RuntimeError(message or "document_engine block failed")
