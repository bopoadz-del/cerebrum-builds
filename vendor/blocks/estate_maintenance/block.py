...
Wraps vendor.cerebrum.blocks.estate_maintenance into a synchronous run() function.
"""
import os as _os
...
import asyncio
from vendor.cerebrum.blocks.estate_maintenance import EstateMaintenanceBlock
...
def run(**kwargs):
    ...
    """
    instance = _instantiate_store_block(EstateMaintenanceBlock)
