...
Wraps vendor.cerebrum.blocks.estate_registry into a synchronous run() function.
"""

import asyncio
from vendor.cerebrum.blocks.estate_registry import EstateRegistryBlock
...
def run(**kwargs):
    ...
    """
    instance = _instantiate_store_block(EstateRegistryBlock)
