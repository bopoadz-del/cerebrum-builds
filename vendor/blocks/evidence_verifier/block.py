...
Wraps vendor.cerebrum.blocks.evidence_verifier into a synchronous run() function.
"""

import asyncio
from vendor.cerebrum.blocks.evidence_verifier import EvidenceVerifierBlock
...
def run(**kwargs):
    ...
    """
    instance = _instantiate_store_block(EvidenceVerifierBlock)
