...
Wraps vendor.cerebrum.blocks.file_hasher into a synchronous run() function.
"""
...
def run(**kwargs):
    ...
    """
    block_cls = get_block("file_hasher")
    ...
    if envelope.get("status") == "error":
        ...
        raise RuntimeError(message or "file_hasher block failed")
