...
Wraps vendor.cerebrum.blocks.knowledge into a synchronous run() function.
"""
import os as _os
...
def run(**kwargs):
    ...
    if envelope.get("status") == "error":
        ...
        raise RuntimeError(message or "knowledge block failed")
