...
Wraps vendor.cerebrum.blocks.multi_tenant_rbac into a synchronous run() function.
"""
import os as _os
...
import asyncio
from vendor.cerebrum.blocks.multi_tenant_rbac import MultiTenantRbacBlock
...
def run(**kwargs):
    instance = _instantiate_store_block(MultiTenantRbacBlock)
