...
Wraps vendor.cerebrum.blocks.notification into a synchronous run() function.
"""
import os as _os
...
def run(**kwargs):
    ...
    """
    block_cls = get_block("notification")
    ...
    if envelope.get("status") == "error":
        ...
        raise RuntimeError(message or "notification block failed")
