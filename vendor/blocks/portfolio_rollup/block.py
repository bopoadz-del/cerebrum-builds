...
Wraps vendor.cerebrum.blocks.portfolio_rollup into a synchronous run() function.
"""
import os as _os
...
import asyncio
from vendor.cerebrum.blocks.portfolio_rollup import PortfolioRollupBlock
...
def run(**kwargs):
    ...
    """
    instance = _instantiate_store_block(PortfolioRollupBlock)
