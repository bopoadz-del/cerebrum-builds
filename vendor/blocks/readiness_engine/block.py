...
Wraps vendor.cerebrum.blocks.readiness_engine into a synchronous run() function.
"""

import asyncio
from vendor.cerebrum.blocks.readiness_engine import ReadinessEngineBlock
...
def run(**kwargs):
    ...
    """
    instance = _instantiate_store_block(ReadinessEngineBlock)
