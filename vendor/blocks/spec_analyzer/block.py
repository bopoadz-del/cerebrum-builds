...
Wraps vendor.cerebrum.blocks.spec_analyzer into a synchronous run() function.
"""
...
def run(**kwargs):
    ...
    """
    block_cls = get_block("spec_analyzer")
    ...
    if envelope.get("status") == "error":
        ...
        raise RuntimeError(message or "spec_analyzer block failed")
