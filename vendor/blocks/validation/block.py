...
Wraps vendor.cerebrum.blocks.validation into a synchronous run() function.
"""
...
def run(**kwargs):
    ...
    """
    block_cls = get_block("validation")
    ...
    if envelope.get("status") == "error":
        ...
        raise RuntimeError(message or "validation block failed")
