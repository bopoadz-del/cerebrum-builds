...
_BLOCK_DEFS = {
    ...
    "evidence_verifier": ("vendor.cerebrum.blocks.evidence_verifier", "EvidenceVerifierBlock"),
    "file_hasher": ("vendor.cerebrum.blocks.file_hasher", "FileHasherBlock"),
    ...
    "portfolio_rollup": ("vendor.cerebrum.blocks.portfolio_rollup", "PortfolioRollupBlock"),
    ...
    "spec_analyzer": ("vendor.cerebrum.blocks.spec_analyzer", "SpecAnalyzerBlock"),
